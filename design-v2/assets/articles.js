...
window.ARTICLES = [
  {
    ...
    "title": {
      ...
      "cz": "Zkušební příspěvek — výtvarné dílny pro seniory",
      "it": "Post di prova — laboratori artistici per anziani",
      "sk": "Ukážkový príspevok — výtvarné dielne pre seniorov",
      "de": "Testbeitrag – Kunstworkshops für Senioren",
    ...
    "lead": {
      ...
      "cz": "V srpnu jsme pozvali seniory z Lublinu na výtvarné dílny. Toto je zkušební příspěvek – testujeme automatické překlady.",
      "it": "Ad agosto abbiamo invitato gli anziani di Lublino a partecipare a dei laboratori artistici. Questo è un post di prova: stiamo verificando le traduzioni automatiche.",
      ...
      "de": "Im August haben wir Senioren aus Lublin zu einem Kunstworkshop eingeladen. Dies ist ein Testbeitrag – wir prüfen die automatischen Übersetzungen.",
    ...
    "body": {
      ...
      "cz": [
        "Na konci srpna uspořádala nadace „Fundacja Stock“ výtvarné dílny pro dvacet seniorů z lubelských domovů sociální péče. Účastníci tři hodiny malovali krajiny inspirované Starým Městem a hotová díla budou na podzim vystavena v sídle nadace.",
        "S přípravou setkání nám pomohli dobrovolníci a naše partnerské sdružení „Homo Faber“. Další workshopy plánujeme na říjen – informace o nich zveřejníme v našich novinkách."
      ],
      "it": [
        "Alla fine di agosto, la fondazione “Fundacja Stock” ha organizzato un laboratorio artistico per venti anziani provenienti dalle case di riposo di Lublino. Per tre ore i partecipanti hanno dipinto paesaggi ispirati al Centro Storico, e le opere realizzate saranno esposte in autunno in una mostra presso la sede della fondazione.",
        "All’organizzazione dell’incontro hanno contribuito alcuni volontari e l’associazione nostra partner “Homo Faber”. Stiamo programmando i prossimi laboratori per ottobre: le informazioni saranno pubblicate nella nostra sezione “Notizie”."
      ],
      "sk": [
      ...
      "de": [
        "Ende August organisierte die Stiftung „Fundacja Stock“ einen Malworkshop für zwanzig Senioren aus Sozialheimen in Lublin. Drei Stunden lang malten die Teilnehmer Landschaften, die von der Altstadt inspiriert waren, und die fertigen Werke werden im Herbst in einer Ausstellung im Sitz der Stiftung zu sehen sein.",
        "Bei der Vorbereitung des Treffens haben Freiwillige sowie der befreundete Verein „Homo Faber“ mitgeholfen. Die nächsten Workshops planen wir für Oktober – Informationen dazu werden in unseren Neuigkeiten veröffentlicht."
      ],
      "fr": [
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Die Malerei Wojciech Gersons im Sozialhilfeheim in der Ametystowa-Straße",
    ...
    "lead": {
      ...
      "de": "Eine weitere inspirierende Kunstbegegnung fand im Sozialhilfeheim in der Ametystowa-Straße in Lublin statt.",
    ...
    "body": {
      ...
      "sk": [
        "Mali sme obrovské potešenie privítať pani Jolantu Polańskú, vynikajúcu kurátorku z Národného múzea v Lubline, ktorá predniesla fascinujúcu prednášku o maliarstve a umeleckom odkaze Wojciecha Gersona.",
        "Wojciech Gerson (1831–1901) bol jedným z najvýznamnejších poľských maliarov 19. storočia, popredným predstaviteľom poľského realizmu a zanieteným propagátorom historického a krajinárskeho maliarstva. Bol tiež výnimočným pedagógom, ktorý učil a inšpiroval generácie umelcov vrátane takých maliarov ako Józef Chełmoński, Leon Wyczółkowski, Władysław Podkowiński a Józef Pankiewicz.",
        "Bolo to ďalšie nádherné Stretnutie s umením, ktoré v domove sociálnych služieb viedla pani Jolanta Polańska. Za svoju oddanosť a mimoriadny prínos k tomu, že do životov obyvateľov prináša svetlo, krásu a radosť, dostala špeciálny ďakovný diplom."
      ],
      "de": [
        "Wir hatten die große Freude, Frau Jolanta Polańska bei uns zu begrüßen, eine herausragende Kuratorin des Nationalmuseums in Lublin, die einen faszinierenden Vortrag über die Malerei und das künstlerische Erbe Wojciech Gersons hielt.",
        "Wojciech Gerson (1831–1901) war einer der bedeutendsten polnischen Maler des 19. Jahrhunderts, ein führender Vertreter des polnischen Realismus und ein leidenschaftlicher Förderer der Historien- und Landschaftsmalerei. Er war zudem ein außergewöhnlicher Pädagoge, der Generationen von Künstlern unterrichtete und inspirierte, darunter Maler wie Józef Chełmoński, Leon Wyczółkowski, Władysław Podkowiński und Józef Pankiewicz.",
        "Es war eine weitere wunderbare Kunstbegegnung, die Frau Jolanta Polańska im Sozialhilfeheim leitete. In Anerkennung ihres Engagements und ihres außergewöhnlichen Beitrags, Licht, Schönheit und Freude in das Leben der Bewohnerinnen und Bewohner zu bringen, erhielt sie ein besonderes Ehrendiplom."
      ],
      "fr": [
        "Nous avons eu le grand plaisir d’accueillir Mme Jolanta Polańska, éminente conservatrice du Musée national de Lublin, qui a donné une conférence fascinante sur la peinture et l’héritage artistique de Wojciech Gerson.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Wir unterstützen die, die andere unterstützen",
    ...
    "lead": {
      ...
      "de": "Die Stiftung Stock hat eine Schulungsreihe für 30 Mitarbeitende der städtischen Familienhilfezentren (MOPR) in Lublin abgeschlossen.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Musik- und Sportstipendium — ein weiterer Sieg",
    ...
    "lead": {
      ...
      "de": "Piotr Pawlik ist unserem Musik- und Sportstipendienprogramm beigetreten, das die Stiftung Stock gemeinsam mit Homo Faber organisiert.",
    ...
    "body": {
      ...
      "sk": [
        "Piotr Pawlik sa venuje kórejskému bojovému umeniu (Taekwon-Do), v ktorom pretekári súťažia vo viacerých disciplínach, ako sú zápasy, zostavy a špeciálne techniky. Súťaží v kategórii juniorov a dosahuje výrazné výsledky doma aj v zahraničí.",
        "V apríli 2026 dosiahol Piotr spolu s reprezentáciou ďalší úspech, keď získal 3. miesto v tímových zostavách juniorov na majstrovstvách Európy v Maribore. Predtým bol spolu s klubovými spoluhráčmi ocenený aj primátorom mesta Lublin za športové úspechy.",
        "V roku 2025 získal Piotr titul majstra Poľska juniorov v individuálnych zápasoch, čo mu prinieslo nomináciu do reprezentácie. Ako reprezentant Poľska sa v septembri 2025 zúčastnil na medzinárodnom zápase vo Švédsku, kde obsadil 4. miesto v kategórii do 65 kg. Veľmi nás tešia také výnimočné úspechy už na samom začiatku."
      ],
      "de": [
        "Piotr Pawlik betreibt eine koreanische Kampfkunst (Taekwon-Do), in der die Athleten in mehreren Disziplinen antreten, etwa Kampf, Formen und Spezialtechniken. Er startet in der Juniorenklasse und erzielt bedeutende Erfolge im In- und Ausland.",
        "Im April 2026 gelang Piotr gemeinsam mit der Nationalmannschaft ein weiterer Erfolg: Bei der Europameisterschaft in Maribor belegte er den 3. Platz in den Mannschaftsformen der Junioren. Zuvor war er zusammen mit seinen Vereinskameraden auch vom Stadtpräsidenten von Lublin für seine sportlichen Leistungen geehrt worden.",
        "2025 gewann Piotr den Titel des Polnischen Juniorenmeisters im Einzelkampf, was ihm die Berufung in die Nationalmannschaft einbrachte. Als Vertreter Polens nahm er im September 2025 an einem internationalen Wettkampf in Schweden teil, wo er in der Kategorie bis 65 kg den 4. Platz belegte. Wir freuen uns sehr über so herausragende Erfolge gleich zu Beginn."
      ],
      "fr": [
        "Piotr Pawlik pratique un art martial coréen (le Taekwon-Do), dans lequel les athlètes concourent dans plusieurs disciplines telles que le combat, les formes et les techniques spéciales. Il concourt dans la catégorie junior et obtient des résultats remarquables tant en Pologne qu’à l’étranger.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Über Generationen hinweg — Kunstbegegnung im UrbanLab",
    ...
    "lead": {
      ...
      "de": "Im Hauptsaal des Rathauses fand eine besondere Kulturveranstaltung der Stiftung Stock statt, die der Kunst und ihrer generationenübergreifenden Dimension gewidmet war.",
    ...
    "body": {
      ...
      "sk": [
        "Stretnutie viedla vynikajúca kurátorka Národného múzea v Lubline Danuta Szewczyk-Prokurat. Prednáška sa zamerala na fascinujúci fenomén umeleckého talentu odovzdávaného z generácie na generáciu a ukázala, ako tvorivosť a majstrovstvo dokážu v rodinách prekonávať čas.",
        "Prezentáciu obohatili pozoruhodné príklady z dejín umenia vrátane diel Pietera Bruegela, Petra Paula Rubensa a rodiny Kossakovcov, ktoré ilustrujú, ako sa umelecké dedičstvo vyvíja naprieč generáciami. Mimoriadne pútavá časť stretnutia bola venovaná Sagrada Família — majstrovskému dielu Antoniho Gaudího v Barcelone, na ktorého stavbe sa podieľalo mnoho generácií umelcov a architektov.",
        "Podujatie bolo určené seniorom v starostlivosti radnice. Bolo inšpiratívnou príležitosťou zamyslieť sa nad kontinuitou, dedičstvom a nadčasovou silou umenia, ktoré spája ľudí naprieč generáciami."
      ],
      "de": [
        "Die Begegnung leitete die herausragende Kuratorin des Nationalmuseums in Lublin, Danuta Szewczyk-Prokurat. Der Vortrag widmete sich dem faszinierenden Phänomen des künstlerischen Talents, das von Generation zu Generation weitergegeben wird, und zeigte, wie Kreativität und Können innerhalb von Familien die Zeit überdauern können.",
        "Bereichert wurde der Vortrag durch bemerkenswerte Beispiele aus der Kunstgeschichte, darunter Werke von Pieter Bruegel, Peter Paul Rubens und der Familie Kossak, die veranschaulichen, wie sich künstlerisches Erbe über Generationen hinweg entwickelt. Ein besonders fesselnder Teil des Treffens war der Sagrada Família gewidmet — dem Meisterwerk Antoni Gaudís in Barcelona, an dessen Bau mehrere Generationen von Künstlern und Architekten beteiligt waren.",
        "Die Veranstaltung richtete sich an Seniorinnen und Senioren, die vom Rathaus betreut werden. Sie bot eine inspirierende Gelegenheit, über Kontinuität, Vermächtnis und die bleibende Kraft der Kunst nachzudenken, die Menschen über Generationen hinweg verbindet."
      ],
      "fr": [
        "La rencontre était animée par Danuta Szewczyk-Prokurat, éminente conservatrice du Musée national de Lublin. La conférence portait sur le phénomène fascinant du talent artistique transmis de génération en génération, montrant comment la créativité et le savoir-faire peuvent traverser le temps au sein des familles.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Stiftung Stock vom Kriseninterventionszentrum ausgezeichnet",
    ...
    "lead": {
      ...
      "de": "In Lublin wurde das 20-jährige Bestehen des Kriseninterventionszentrums gefeiert — einer städtischen Einrichtung, die Menschen in schwierigen Lebenslagen unterstützt.",
    ...
    "body": {
      ...
      "sk": [
        "CIK už roky poskytuje bezplatnú odbornú psychologickú, terapeutickú, právnu a krízovú intervenčnú podporu, dostupnú obyvateľom mesta bez odporúčania. Pomoc smeruje okrem iného k ľuďom, ktorí zažívajú násilie, závislosti, osobné krízy alebo náhle životné udalosti, ako je strata blízkej osoby či zamestnania.",
        "Počas jubilea boli ocenení partneri podporujúci činnosť Centra. Medzi nimi bola aj Nadácia Stock, ktorá získala čestné uznanie za spoločenskú angažovanosť. V mene nadácie ocenenie prevzal Paweł Jabłoński, ktorý bol ocenený aj individuálne za osobný prínos k podporným aktivitám.",
        "Na podujatí sa zúčastnili zástupcovia mestských orgánov, pomocných inštitúcií a mimovládnych organizácií spolupracujúcich s CIK, čo zdôraznilo význam spolupráce pri pomoci ľuďom v kríze."
      ],
      "de": [
        "Seit Jahren bietet das CIK kostenlose, fachkundige psychologische, therapeutische und rechtliche Unterstützung sowie Kriseninterventionen an, die den Einwohnern der Stadt ohne Überweisung zur Verfügung stehen. Die Hilfe richtet sich unter anderem an Menschen, die von Gewalt, Sucht, persönlichen Krisen oder plötzlichen Lebensereignissen wie dem Verlust eines geliebten Menschen oder des Arbeitsplatzes betroffen sind.",
        "Im Rahmen der Jubiläumsfeier wurden Partner ausgezeichnet, die die Arbeit des Zentrums unterstützen. Zu ihnen gehörte die Stiftung Stock, die eine Anerkennungsurkunde für ihr soziales Engagement erhielt. Im Namen der Stiftung nahm Paweł Jabłoński die Auszeichnung entgegen; er wurde zudem individuell für seinen persönlichen Beitrag zu den Hilfsaktivitäten geehrt.",
        "An der Veranstaltung nahmen Vertreter der Stadtverwaltung, von Hilfseinrichtungen und Nichtregierungsorganisationen teil, die mit dem CIK zusammenarbeiten — ein Zeichen dafür, wie wichtig die Zusammenarbeit bei der Hilfe für Menschen in Krisen ist."
      ],
      "fr": [
        "Depuis des années, le CIK offre un soutien spécialisé gratuit — psychologique, thérapeutique, juridique et d’intervention de crise — accessible aux habitants sans prescription. L’aide s’adresse notamment aux personnes confrontées à la violence, aux addictions, aux crises personnelles ou à des événements soudains, comme la perte d’un proche ou d’un emploi.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Lernen Sie unseren Freiwilligen kennen — den Gitarrenbauer Łukasz Murawski",
    ...
    "lead": {
      ...
      "de": "Die Stiftung Stock ist stolz, mitteilen zu können, dass wir einen außergewöhnlichen Freiwilligen gewonnen haben — einen Meister des Gitarrenbaus und Erbauer von E-Gitarren.",
    ...
    "body": {
      ...
      "sk": [
        "Łukasz Murawski, tvorca elektrických gitár, sa po tom, čo sa dozvedel o našom programe hudobných štipendií pre talentovaných mladých ľudí, ktorí museli pre vypuknutie vojny opustiť hudobné vzdelávanie, rozhodol konať. Veľkoryso venoval svoju ručne vyrobenú elektrickú gitaru účastníkom nášho programu.",
        "Nástroj prevzali naši učitelia Olga a Mirek z Homo Faber, ktorí sa postarajú o jeho skvelé využitie. Nástroj je naozaj výnimočný — krásne vyrobený, ľahký, ľahko sa na ňom hrá a má fantastický zvuk, vďaka čomu je ideálny na učenie a rozvíjanie hudobných zručností.",
        "Sme hlboko vďační za toto pozoruhodné gesto a podporu."
      ],
      "de": [
        "Łukasz Murawski, Erbauer von E-Gitarren, beschloss zu handeln, nachdem er von unserem Musikstipendienprogramm für talentierte junge Menschen erfahren hatte, die ihre musikalische Ausbildung wegen des Kriegsausbruchs aufgeben mussten. Großzügig schenkte er den Teilnehmern unseres Programms seine handgefertigte E-Gitarre.",
        "Das Instrument nahmen unsere Lehrer Olga und Mirek von Homo Faber entgegen, die dafür sorgen werden, dass es bestens genutzt wird. Das Instrument ist wirklich außergewöhnlich — wunderschön gefertigt, leicht, einfach zu spielen und mit einem fantastischen Klang, was es ideal zum Lernen und zur Entwicklung musikalischer Fähigkeiten macht.",
        "Wir sind zutiefst dankbar für diese bemerkenswerte Geste und Unterstützung."
      ],
      "fr": [
        "Łukasz Murawski, créateur de guitares électriques, a décidé d’agir après avoir appris l’existence de notre programme de bourses musicales destiné à de jeunes talents contraints d’abandonner leur éducation musicale en raison de l’éclatement de la guerre. Il a généreusement offert sa guitare électrique fabriquée à la main aux participants de notre programme.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Treffen für Senioren über Kunst und Leben von Adam Chmielowski",
    ...
    "lead": {
      ...
      "de": "Im Rathaus von Lublin stellte die Kuratorin Anna Czajczyk am Jahrestag des Januaraufstands das Werk von Adam Chmielowski — Bruder Albert — vor.",
    ...
    "body": {
      ...
      "sk": [
        "V budove radnice v Lubline, v deň výročia vypuknutia januárového povstania, predniesla vynikajúca kurátorka Národného múzea Anna Czajczyk ilustrovanú prednášku o tvorbe Adama Chmielowského, neskôr známeho ako brat Albert. Podujatie bolo určené seniorom v starostlivosti mestského úradu.",
        "Adam Chmielowski bol poľský maliar a františkán, ktorý začal umeleckú kariéru, než zasvätil život službe chudobným a ľuďom bez domova. Zúčastnil sa januárového povstania v roku 1863 a neskôr študoval maliarstvo v popredných európskych umeleckých centrách vrátane Paríža a Mníchova.",
        "Po hlbokom náboženskom povolaní založil kongregácie albertínov a albertínok, ktoré sa venujú pomoci núdznym — príbeh, ktorý poslucháčov hlboko oslovil."
      ],
      "de": [
        "Im Rathausgebäude in Lublin hielt die hervorragende Kuratorin des Nationalmuseums, Anna Czajczyk, am Jahrestag des Ausbruchs des Januaraufstands einen bebilderten Vortrag über das Werk von Adam Chmielowski, der später als Bruder Albert bekannt wurde. Die Veranstaltung richtete sich an Senioren, die von der Stadtverwaltung betreut werden.",
        "Adam Chmielowski war ein polnischer Maler und Franziskaner, der seine künstlerische Laufbahn begann, bevor er sein Leben dem Dienst an Armen und Obdachlosen widmete. Er nahm am Januaraufstand von 1863 teil und studierte später Malerei in führenden europäischen Kunstzentren, unter anderem in Paris und München.",
        "Nach einer tiefen religiösen Berufung gründete er die Gemeinschaften der Albertiner-Brüder und -Schwestern, die sich der Hilfe für Bedürftige widmen — eine Geschichte, die die Zuhörer tief berührte."
      ],
      "fr": [
        "Dans le bâtiment de l’hôtel de ville de Lublin, à l’occasion de l’anniversaire du déclenchement de l’insurrection de Janvier, l’excellente conservatrice du Musée national Anna Czajczyk a donné une conférence illustrée sur l’œuvre d’Adam Chmielowski, connu plus tard sous le nom de frère Albert. L’événement s’adressait aux seniors pris en charge par la mairie.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Unsere jungen Bandura-Spieler beim Konzert bei Homo Faber",
    ...
    "lead": {
      ...
      "de": "Ein Bandura-Ensemble aus unserem Stipendienprogramm gab ein bewegendes vorweihnachtliches Konzert am Sitz von Homo Faber.",
    ...
    "body": {
      ...
      "sk": [
        "Nadácia Stock spolu so združením Homo Faber vedie hudobné štipendiá pre talentovanú mládež z Ukrajiny, ktorá musela pre vojnu prerušiť vzdelávanie.",
        "18. decembra odohral súbor banduristov nádherný predvianočný koncert, ktorý publikum dojal a inšpiroval.",
        "Táto iniciatíva je dôležitá, pretože dáva mladým ľuďom skutočnú podporu a šancu ďalej rozvíjať svoje schopnosti napriek ťažkej situácii."
      ],
      "de": [
        "Die Stiftung Stock vergibt gemeinsam mit dem Verein Homo Faber Musikstipendien an talentierte Jugendliche aus der Ukraine, die ihre Ausbildung wegen des Krieges unterbrechen mussten.",
        "Am 18. Dezember gab ein Bandura-Ensemble ein wunderbares vorweihnachtliches Konzert, das das Publikum bewegte und inspirierte.",
        "Diese Initiative ist wichtig, weil sie jungen Menschen echte Unterstützung gibt und ihnen die Chance bietet, ihre Fähigkeiten trotz der schwierigen Lage weiterzuentwickeln."
      ],
      "fr": [
        "La Fondation Stock, avec l’association Homo Faber, gère des bourses musicales pour des jeunes talentueux d’Ukraine contraints d’interrompre leurs études à cause de la guerre.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Kuratorin Barbara Czajkowska nimmt die Bewohner des Sozialhilfeheims mit nach Florenz",
    ...
    "lead": {
      ...
      "de": "Eine Erzählung über die Uffizien brachte Botticelli, Michelangelo und Leonardo in das Sozialhilfeheim in der Ametystowa-Straße.",
    ...
    "body": {
      ...
      "sk": [
        "18. novembra sa v domove sociálnych služieb na Ametystovej ulici v Lubline konalo výnimočné stretnutie. Naša nadácia pozvala Barbaru Czajkowskú, skúsenú kurátorku, ktorá viedla rozprávanie o zbierkach jedného z najvýznamnejších múzeí Florencie — galérie Uffizi.",
        "Hovorila o dielach umelcov ako Botticelli, Michelangelo a Leonardo da Vinci a zrozumiteľne a pútavo vysvetľovala ich príbehy. Opísala tiež, ako sa tieto diela dostali do Florencie a čo robí toto múzeum takým významným dodnes.",
        "Obyvatelia počúvali s obrovským záujmom a mnohí hovorili, že sa cítili, akoby tam naozaj boli — prechádzali sa sálami múzea a videli umenie na vlastné oči. Tešíme sa, že sme mohli priniesť kúsok Florencie na Ametystovú ulicu."
      ],
      "de": [
        "Am 18. November fand im Sozialhilfeheim in der Ametystowa-Straße in Lublin eine besondere Begegnung statt. Unsere Stiftung hatte Barbara Czajkowska eingeladen, eine erfahrene Kuratorin, die von den Sammlungen eines der bedeutendsten Museen von Florenz erzählte — der Uffizien.",
        "Sie sprach über Werke von Künstlern wie Botticelli, Michelangelo und Leonardo da Vinci und erklärte ihre Geschichten anschaulich und fesselnd. Sie schilderte auch, wie diese Werke nach Florenz gelangten und was dieses Museum bis heute so bedeutend macht.",
        "Die Bewohnerinnen und Bewohner hörten mit großem Interesse zu, und viele sagten, sie hätten sich gefühlt, als wären sie wirklich dort gewesen — als gingen sie durch die Säle des Museums und sähen die Kunst mit eigenen Augen. Wir freuen uns, dass wir ein Stück Florenz in die Ametystowa-Straße bringen konnten."
      ],
      "fr": [
        "Le 18 novembre, une rencontre exceptionnelle a eu lieu au foyer d’aide sociale de la rue Ametystowa à Lublin. Notre Fondation a invité Barbara Czajkowska, conservatrice expérimentée, qui a présenté les collections de l’un des plus importants musées de Florence — la Galerie des Offices.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Anna Czajczyk leitet ein Geschichtstreffen für Senioren im Rathaus",
    ...
    "lead": {
      ...
      "de": "Ein Vortrag über die Geschichte des Lubliner Schlossbergs — von der mittelalterlichen Burgsiedlung bis zur Kapelle der Heiligen Dreifaltigkeit.",
    ...
    "body": {
      ...
      "sk": [
        "24. októbra sa na radnici konalo podujatie pre seniorov s Annou Czajczyk, skúsenou kurátorkou. Viedla rozprávanie o histórii lublinského Zámockého vŕšku a zamerala sa na to, ako sa toto miesto menilo v priebehu storočí.",
        "Hovorila o počiatkoch stredovekého hradiska, stavbe gotickej veže a neskoršej premene hradu na väzenie v 19. a 20. storočí. Vysvetlila tiež, ako sa Kaplnka Najsvätejšej Trojice stala jednou z najvýznamnejších pamiatok poľského stredovekého umenia.",
        "Účastníci ocenili možnosť spoznať miestnu históriu jasným a prístupným spôsobom."
      ],
      "de": [
        "Am 24. Oktober fand im Rathaus eine Veranstaltung für Senioren mit Anna Czajczyk statt, einer erfahrenen Kuratorin. Sie hielt einen Vortrag über die Geschichte des Lubliner Schlossbergs und zeigte, wie sich dieser Ort im Laufe der Jahrhunderte verändert hat.",
        "Sie sprach über die Anfänge der mittelalterlichen Burgsiedlung, den Bau des gotischen Turms und die spätere Umwandlung des Schlosses in ein Gefängnis im 19. und 20. Jahrhundert. Sie erklärte auch, wie die Kapelle der Heiligen Dreifaltigkeit zu einem der bedeutendsten Denkmäler der polnischen mittelalterlichen Kunst wurde.",
        "Die Teilnehmer schätzten die Gelegenheit, die lokale Geschichte auf klare und zugängliche Weise kennenzulernen."
      ],
      "fr": [
        "Le 24 octobre, un événement pour les seniors s’est tenu à l’hôtel de ville avec Anna Czajczyk, conservatrice expérimentée. Elle a raconté l’histoire de la colline du Château de Lublin, en montrant comment ce lieu a évolué au fil des siècles.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Stock-Freiwillige sammelten fast 3 Tonnen Abfall",
    ...
    "lead": {
      ...
      "de": "Die Stiftung Stock organisierte gemeinsam mit Freiwilligen aus dem Warschauer Büro eine große Aufräumaktion an der Weichsel.",
    ...
    "body": {
      ...
      "sk": [
        "19. septembra zorganizovala Nadácia Stock veľké upratovanie Visly spolu s dobrovoľníkmi z našej varšavskej kancelárie. Až 60 dobrovoľníkov spojilo sily, aby sa postaralo o brehy rieky — za krásneho počasia a s ešte väčšou energiou si naše tímy vyhrnuli rukávy a pustili sa do práce, na mieste podporované tímom „Czyste Rzeki“.",
        "V duchu priateľského súperenia vytvorili účastníci päťčlenné družstvá a bojovali o titul „Majstrov upratovania“. Víťazná skupina — Kubusie z Lodže — vyzbierala úctyhodných 100 kg odpadu. Všetky tímy spolu odstránili takmer 3 tony odpadkov.",
        "Upratovanie trvalo od 12:00 do 16:00; dobrovoľníci dostali rukavice, vrecia, repelent a vodu a na bezpečnosť dohliadali štyria plavčíci. Po skončení práce sme deň zavŕšili pizzou a chvíľou oslavy spoločného úspechu.",
        "Ďakujeme každému dobrovoľníkovi za nasadenie, energiu a srdce. Spoločne robíme skutočný rozdiel — a už sa nevieme dočkať ďalšieho ročníka."
      ],
      "de": [
        "Am 19. September organisierte die Stiftung Stock gemeinsam mit Freiwilligen aus unserem Warschauer Büro eine große Aufräumaktion an der Weichsel. Ganze 60 Freiwillige bündelten ihre Kräfte, um sich um die Flussufer zu kümmern — bei schönstem Wetter und mit noch größerer Energie krempelten unsere Teams die Ärmel hoch und machten sich an die Arbeit, vor Ort unterstützt vom Team von „Czyste Rzeki“.",
        "Im Geiste eines freundschaftlichen Wettbewerbs bildeten die Teilnehmenden Fünferteams und kämpften um den Titel der „Aufräum-Meister“. Die Siegergruppe — die Kubusie aus Łódź — sammelte beeindruckende 100 kg Abfall. Insgesamt beseitigten alle Teams fast 3 Tonnen Müll.",
        "Die Aufräumaktion dauerte von 12:00 bis 16:00 Uhr; die Freiwilligen wurden mit Handschuhen, Säcken, Mückenschutz und Wasser ausgestattet, und vier Rettungsschwimmer sorgten für die Sicherheit aller. Nach getaner Arbeit ließen wir den Tag mit Pizza und einem Moment des Feierns unseres gemeinsamen Erfolgs ausklingen.",
        "Wir danken jeder Freiwilligen und jedem Freiwilligen für Engagement, Energie und Herz. Gemeinsam bewirken wir einen echten Unterschied — und wir freuen uns schon auf die nächste Ausgabe im kommenden Jahr."
      ],
      "fr": [
        "Le 19 septembre, la Fondation Stock a organisé un grand nettoyage de la Vistule avec les bénévoles de notre bureau de Varsovie. Pas moins de 60 bénévoles ont uni leurs forces pour prendre soin des berges du fleuve — sous un beau soleil et avec une énergie plus grande encore, nos équipes ont retroussé leurs manches et se sont mises au travail, soutenues sur place par l’équipe de « Czyste Rzeki ».",
        "Dans un esprit de compétition amicale, les participants ont formé des équipes de cinq personnes pour se disputer le titre de « Champions du nettoyage ». Le groupe vainqueur — les Kubusie de Łódź — a ramassé pas moins de 100 kg de déchets. Ensemble, toutes les équipes ont retiré près de 3 tonnes de détritus.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Stiftung Stock erhält offiziell den Status einer gemeinnützigen Organisation (OPP)",
    ...
    "lead": {
      ...
      "de": "Mit Stolz geben wir bekannt, dass die Stiftung Stock offiziell den Status einer gemeinnützigen Organisation erhalten hat.",
    ...
    "body": {
      ...
      "sk": [
        "S hrdosťou oznamujeme, že Nadácia Stock oficiálne získala štatút verejnoprospešnej organizácie (OPP). Tento štatút sa udeľuje inštitúciám, ktoré spĺňajú prísne právne a organizačné štandardy a pôsobia plne transparentne a profesionálne.",
        "Týmto štatútom potvrdzujeme svoju dôveryhodnosť a otvorenosť voči darcom, partnerom aj verejnosti. V Poľsku teraz môžeme prijímať 1,5 % z dane z príjmov fyzických osôb a získavame prístup k novým verejným grantom a možnostiam financovania.",
        "Štatút OPP zároveň posilňuje našu pozíciu v spolupráci s inštitúciami, partnerskými organizáciami a dobrovoľníkmi. Je to dôležitý míľnik v rozvoji Nadácie Stock, ktorý nám umožňuje konať ešte účinnejšie a lepšie slúžiť našej komunite."
      ],
      "de": [
        "Mit Stolz geben wir bekannt, dass die Stiftung Stock offiziell den Status einer gemeinnützigen Organisation (OPP) erhalten hat. Dieser Status wird Institutionen verliehen, die strenge rechtliche und organisatorische Standards erfüllen und vollkommen transparent und professionell arbeiten.",
        "Mit diesem Status bekräftigen wir unsere Glaubwürdigkeit und Offenheit gegenüber Spenderinnen und Spendern, Partnern und der Öffentlichkeit. Wir können nun in Polen 1,5 % der Einkommensteuer natürlicher Personen erhalten und bekommen Zugang zu neuen öffentlichen Zuschüssen und Finanzierungsmöglichkeiten.",
        "Der OPP-Status stärkt zudem unsere Position in der Zusammenarbeit mit Institutionen, Partnerorganisationen und Freiwilligen. Dies ist ein wichtiger Meilenstein in der Entwicklung der Stiftung Stock, der es uns ermöglicht, noch wirksamer zu handeln und unserer Gemeinschaft besser zu dienen."
      ],
      "fr": [
        "Nous sommes fiers d’annoncer que la Fondation Stock a officiellement obtenu le statut d’organisation d’utilité publique (OPP). Ce statut est accordé aux institutions qui répondent à des normes juridiques et organisationnelles strictes et qui agissent en toute transparence et avec professionnalisme.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Ein besonderer Ausflug für die Bewohner des Sozialhilfeheims in der Kosmonautów-Straße",
    ...
    "lead": {
      ...
      "de": "Zum ersten Mal nahmen Freiwillige Bewohnerinnen und Bewohner im Rollstuhl mit auf einen langen, fröhlichen Spaziergang durch die Straßen von Lublin.",
    ...
    "body": {
      ...
      "sk": [
        "Nadácia Stock mala tú česť podporiť naozaj výnimočnú iniciatívu pre ľudí so zdravotným postihnutím, ktorí žijú v domove sociálnych služieb na ulici Kosmonautów v Lubline.",
        "Skupina dobrovoľníkov — vrátane jedného z našej nadácie — prvýkrát vzala obyvateľov na vozíkoch na dlhú a radostnú prechádzku mestom. Trasa sa začínala pri domove a viedla ulicami Lublina, cez pešiu zónu, popri Litovskom námestí až do Ľudového parku. Po prechádzke všetkých bezpečne odviezli mikrobusy financované nadáciou.",
        "Atmosféra bola veselá a plná pozitívnej energie. Takýto výlet sa nestáva každý deň a bolo vidieť, koľko pre obyvateľov znamenal. Naši dobrovoľníci sa vracali s plným srdcom a s pocitom zadosťučinenia, že do niekoho dňa priniesli trochu slnka. Sme vďační, že sme mohli byť súčasťou tohto dňa — a už sa tešíme na ďalší."
      ],
      "de": [
        "Die Stiftung Stock hatte die Ehre, eine wirklich besondere Initiative für Menschen mit Behinderung zu unterstützen, die im Sozialhilfeheim in der Kosmonautów-Straße in Lublin leben.",
        "Zum ersten Mal nahm eine Gruppe von Freiwilligen — darunter eine Person aus unserer Stiftung — Bewohnerinnen und Bewohner im Rollstuhl mit auf einen langen und fröhlichen Spaziergang durch die Stadt. Die Route begann am Heim und führte durch die Straßen Lublins, über die Fußgängerzone, am Litauischen Platz vorbei bis zum Ludowy-Park. Nach dem Spaziergang brachten von der Stiftung finanzierte Kleinbusse alle sicher zurück.",
        "Die Stimmung war heiter und voller positiver Energie. Ein solcher Ausflug ist nicht alltäglich, und man konnte sehen, wie viel er den Bewohnerinnen und Bewohnern bedeutete. Unsere Freiwilligen kehrten mit vollem Herzen zurück und mit der Genugtuung, ein wenig Sonne in den Tag anderer gebracht zu haben. Wir sind dankbar, Teil dieses Tages gewesen zu sein — und freuen uns schon auf den nächsten."
      ],
      "fr": [
        "La Fondation Stock a eu l’honneur de soutenir une initiative vraiment exceptionnelle destinée aux personnes en situation de handicap qui vivent au foyer d’aide sociale de la rue Kosmonautów, à Lublin.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Schulungstag für die Mitarbeitenden des Sozialhilfeheims",
    ...
    "lead": {
      ...
      "de": "Ein Workshop für die Mitarbeitenden des Sozialhilfeheims zur Unterstützung suchtgefährdeter Menschen.",
    ...
    "body": {
      ...
      "sk": [
        "28. mája zorganizovala Nadácia Stock ďalšie stretnutie pre sociálny personál domova sociálnych služieb pre osoby so zdravotným postihnutím, venované podpore ľudí ohrozených závislosťou.",
        "Workshop spájal teoretické a praktické prvky: účastníci spoznali mechanizmy závislosti, analyzovali prípadové štúdie a učili sa rozpoznávať varovné signály a zapojili sa do diskusie s našimi skúsenými terapeutmi — Annou Kalbus a Jerzym Brożynom.",
        "Toto školenie je kľúčové, pretože sociálni pracovníci si často ako prví všimnú, že si niekto nevie poradiť. Prehlbovaním vedomostí a zdokonaľovaním praktických zručností bude tím lepšie pripravený pomáhať ľuďom v kríze a posilní prevenciu závislostí. Ďakujeme všetkým sociálnym pracovníkom za účasť — vaše nasadenie pomáha vytvárať bezpečnejšiu a viac podporujúcu komunitu."
      ],
      "de": [
        "Am 28. Mai veranstaltete die Stiftung Stock ein weiteres Treffen für die Sozialarbeitenden des Sozialhilfeheims für Menschen mit Behinderungen, das der Unterstützung suchtgefährdeter Personen gewidmet war.",
        "Der Workshop verband theoretische und praktische Elemente: Die Teilnehmenden lernten die Mechanismen der Sucht kennen, analysierten Fallbeispiele, um Warnsignale zu erkennen, und beteiligten sich an einer Frage-und-Antwort-Runde mit unseren erfahrenen Therapeuten — Anna Kalbus und Jerzy Brożyna.",
        "Diese Schulung ist entscheidend, denn Sozialarbeitende bemerken oft als Erste, wenn jemand nicht mehr weiterweiß. Durch vertieftes Wissen und geschärfte praktische Fähigkeiten ist das Team besser darauf vorbereitet, Menschen in Krisen zu helfen und die Suchtprävention zu stärken. Wir danken allen Sozialarbeitenden für ihre Teilnahme — Ihr Engagement trägt dazu bei, eine sicherere und solidarischere Gemeinschaft zu schaffen."
      ],
      "fr": [
        "Le 28 mai, la Fondation Stock a organisé une nouvelle rencontre pour le personnel social du foyer d’aide sociale pour personnes en situation de handicap, consacrée à l’accompagnement des personnes exposées au risque d’addiction.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Ein Tag der kulturellen Begegnungen mit der Stiftung Stock",
    ...
    "lead": {
      ...
      "de": "Polnische patriotische Malerei und eine virtuelle Reise durch die Vatikanischen Museen — zwei Kunstveranstaltungen an einem Tag, für zwei verschiedene Gemeinschaften.",
    ...
    "body": {
      ...
      "sk": [
        "9. apríla zorganizovala Nadácia Stock dve obohacujúce umelecké podujatia a priniesla radosť z umenia dvom rôznym komunitám.",
        "Prvé sa konalo v domove pre osoby so zdravotným postihnutím, kde pani Jolanta Polańska, uznávaná kurátorka Národného múzea, predstavila digitálnu výstavu venovanú vlasteneckým témam v poľskom maliarstve. Prezentácia zahŕňala diela Jana Matejku a rodiny Kossakovcov a ponúkla obyvateľom živý kontakt s národným dedičstvom.",
        "V ten istý deň viedla pani Barbara Czajkowska, takisto z Národného múzea, na radnici prezentáciu o zbierkach Vatikánskych múzeí. Podujatie určené seniorom sa stretlo s vrelým prijatím — mnohí účastníci hovorili, že sa cítili, akoby Vatikán navštívili osobne. Poctila nás prítomnosť zástupkyne primátora Lublinu pre sociálne veci, pani Anny Augustyniak."
      ],
      "de": [
        "Am 9. April organisierte die Stiftung Stock zwei bereichernde Kunstveranstaltungen und brachte die Freude an der Kunst zu zwei verschiedenen Gemeinschaften.",
        "Die erste fand in einem Pflegeheim für Menschen mit Behinderungen statt, wo Frau Jolanta Polańska, eine angesehene Kuratorin des Nationalmuseums, eine digitale Ausstellung zu patriotischen Motiven in der polnischen Malerei präsentierte. Gezeigt wurden Werke von Jan Matejko und der Familie Kossak, die den Bewohnerinnen und Bewohnern eine lebendige Verbindung zum nationalen Erbe boten.",
        "Am selben Tag hielt Frau Barbara Czajkowska, ebenfalls vom Nationalmuseum, im Rathaus einen Vortrag über die Sammlungen der Vatikanischen Museen. Die an Seniorinnen und Senioren gerichtete Veranstaltung stieß auf herzliche Resonanz — viele Teilnehmende sagten, sie hätten sich gefühlt, als hätten sie den Vatikan persönlich besucht. Geehrt hat uns die Anwesenheit der stellvertretenden Stadtpräsidentin von Lublin für soziale Angelegenheiten, Frau Anna Augustyniak."
      ],
      "fr": [
        "Le 9 avril, la Fondation Stock a organisé deux événements artistiques enrichissants, apportant la joie de l’art à deux communautés différentes.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Partnerschaft mit einem Lubliner Sozialhilfeheim — Kunst für die Bewohner",
    ...
    "lead": {
      ...
      "de": "Eine neue Partnerschaft mit dem Sozialhilfeheim in der Kosmonautów-Straße beginnt mit einer multimedialen Reise durch die Meisterwerke des Louvre.",
    ...
    "body": {
      ...
      "sk": [
        "Nadácia Stock oznámila nové partnerstvo s Domovom sociálnych služieb pre osoby s telesným postihnutím na ulici Kosmonautów 78 v Lubline. Cieľom spolupráce je obohatiť kultúrny život obyvateľov prostredníctvom série podujatí venovaných umeniu.",
        "Domov sa špecializuje na starostlivosť a rehabilitáciu dospelých s telesným postihnutím — okrem iného so sklerózou multiplex, poraneniami miechy, úrazmi mozgu, stavmi po mozgovej príhode a svalovou dystrofiou. Zariadenie má 90 obyvateľov, väčšina z nich sa pohybuje na invalidnom vozíku, a poskytuje každodennú starostlivosť, lekársky dohľad, rehabilitáciu aj ergoterapiu.",
        "Partnerstvo otvorilo podujatie „Stretnutie s umením“ v hlavnej sále domova. Magdalena Norkowska, vynikajúca kurátorka Národného múzea v Lubline, viedla pútavú multimediálnu prezentáciu majstrovských diel Louvru. Podujatia sa zúčastnilo takmer 40 ľudí, ktorí ho prijali s veľkým nadšením.",
        "Povzbudené týmto úspechom plánujú Nadácia Stock a domov pokračovať v podobných podujatiach a dopriať obyvateľom trvalý kontakt s umením."
      ],
      "de": [
        "Die Stiftung Stock hat eine neue Partnerschaft mit dem Sozialhilfeheim für Menschen mit körperlicher Behinderung in der Kosmonautów-Straße 78 in Lublin bekannt gegeben. Die Zusammenarbeit soll das kulturelle Leben der Bewohnerinnen und Bewohner durch eine Reihe von Veranstaltungen rund um die Kunst bereichern.",
        "Das Heim ist auf Pflege und Rehabilitation von Erwachsenen mit körperlichen Behinderungen spezialisiert — unter anderem mit Multipler Sklerose, Rückenmarksverletzungen, Schädel-Hirn-Traumata, Zuständen nach Schlaganfall und Muskeldystrophie. Die Einrichtung bietet Platz für 90 Bewohnerinnen und Bewohner, von denen die meisten einen Rollstuhl nutzen, und gewährleistet tägliche Betreuung, medizinische Aufsicht, Rehabilitation sowie Ergotherapie.",
        "Eröffnet wurde die Partnerschaft mit der Veranstaltung „Kunstbegegnung“ im großen Saal des Heims. Magdalena Norkowska, herausragende Kuratorin des Nationalmuseums in Lublin, führte durch eine fesselnde multimediale Präsentation der Meisterwerke des Louvre. An der Veranstaltung nahmen fast 40 Personen teil, die sie mit großer Begeisterung aufnahmen.",
        "Ermutigt durch diesen Erfolg planen die Stiftung Stock und das Heim, weitere ähnliche Veranstaltungen zu organisieren und den Bewohnerinnen und Bewohnern so einen dauerhaften Kontakt zur Kunst zu ermöglichen."
      ],
      "fr": [
        "La Fondation Stock a annoncé un nouveau partenariat avec le foyer d’aide sociale pour personnes en situation de handicap physique, situé au 78 rue Kosmonautów à Lublin. Cette collaboration vise à enrichir la vie culturelle des résidents à travers une série d’événements consacrés à l’art.",
        "L’établissement est spécialisé dans les soins et la rééducation d’adultes en situation de handicap moteur — notamment sclérose en plaques, lésions de la moelle épinière, traumatismes crâniens, séquelles d’accident vasculaire cérébral et dystrophie musculaire. Il accueille 90 résidents, dont la plupart se déplacent en fauteuil roulant, et assure des soins quotidiens, une surveillance médicale, de la rééducation ainsi que de l’ergothérapie.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Matejko — eine Kunstbegegnung im Nationalmuseum",
    ...
    "lead": {
      ...
      "de": "Eine Reise durch Geschichte und Patriotismus im Werk eines der größten polnischen Maler, organisiert mit der Abteilung für soziale Initiativen.",
    ...
    "body": {
      ...
      "sk": [
        "Národné múzeum hostilo ďalšie Stretnutie s umením, zorganizované v spolupráci s odborom sociálnych iniciatív radnice. Bola to jedinečná príležitosť spoznať tvorbu jedného z najväčších poľských maliarov — Jana Matejku — vlastenca a vizionára poľskej minulosti. Na podujatí sa zúčastnili ľudia, ktorí potrebujú každodennú pomoc a majú obmedzený prístup k umeniu; spoluorganizovaním tohto podujatia Nadácia Stock otvára nový smer svojej činnosti a podobné podujatia bude financovať počas celého roka.",
        "Jolanta Polańska, kurátorka Národného múzea, vzala účastníkov na cestu históriou, vlastenectvom a pozoruhodnou víziou umelca. Stretnutie sa začalo projekciou v kinosále múzea — prezentáciou o Matejkovi nielen ako maliarovi, ale aj vizionárovi formujúcom poľské historické rozprávanie.",
        "Druhou časťou bola návšteva Galérie poľského maliarstva, kde sa účastníci zastavili pri dvoch Matejkových majstrovských dielach vrátane „Lublinskej únie“. Tieto diela ukázali, ako umelec znovu vytváral a formoval minulosť — jedinečná príležitosť vidieť dejiny očami veľkého tvorcu."
      ],
      "de": [
        "Das Nationalmuseum war Gastgeber einer weiteren Kunstbegegnung, die in Zusammenarbeit mit der Abteilung für soziale Initiativen des Rathauses organisiert wurde. Es war eine einzigartige Gelegenheit, das Werk eines der größten polnischen Maler kennenzulernen — Jan Matejkos, eines Patrioten und Visionärs der polnischen Vergangenheit. An der Veranstaltung nahmen Menschen teil, die auf tägliche Unterstützung angewiesen sind und nur begrenzten Zugang zur Kunst haben; mit der Mitorganisation dieser Veranstaltung schlägt die Stiftung Stock eine neue Richtung ihrer Tätigkeit ein und wird das ganze Jahr über weitere solche Veranstaltungen finanzieren.",
        "Jolanta Polańska, Kuratorin des Nationalmuseums, nahm die Teilnehmenden mit auf eine Reise durch Geschichte, Patriotismus und die außergewöhnliche Vision des Künstlers. Das Treffen begann mit einer Vorführung im Kinosaal des Museums — einer Präsentation über Matejko nicht nur als Maler, sondern auch als Visionär, der die polnische Geschichtserzählung prägte.",
        "Der zweite Teil war ein Besuch der Galerie der polnischen Malerei, wo die Teilnehmenden an zwei Meisterwerken Matejkos verweilten, darunter die „Union von Lublin“. Diese Werke zeigten, wie der Künstler die Vergangenheit nachbildete und formte — eine einzigartige Gelegenheit, die Geschichte mit den Augen eines großen Künstlers zu sehen."
      ],
      "fr": [
        "Le Musée national a accueilli une nouvelle Rencontre avec l’art, organisée en coopération avec le Département des initiatives sociales de l’hôtel de ville. Ce fut une occasion unique de découvrir l’œuvre de l’un des plus grands peintres polonais — Jan Matejko — patriote et visionnaire du passé de la Pologne. L’événement a réuni des personnes nécessitant une aide quotidienne et ayant un accès limité à l’art ; en le coorganisant, la Fondation Stock ouvre une nouvelle direction dans ses activités et financera d’autres événements de ce type tout au long de l’année.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Flavours-of-Change-Zuschüsse: eine Gemeinschaftsinitiative im kroatischen Šišan",
    ...
    "lead": {
      ...
      "de": "Im kroatischen Šišan wurde der örtliche Kindergarten „Bubamara“ dank eines Gemeinschaftsprojekts in einen lebendigen Ort des Lernens und Spielens verwandelt.",
    ...
    "body": {
      ...
      "sk": [
        "V chorvátskom Šišane bola miestna škôlka „Bubamara“ premenená na živý priestor vzdelávania a hier vďaka komunitnému projektu, do ktorého sa zapojilo 24 dobrovoľníkov, pedagógov a obyvateľov. Projekt, čiastočne financovaný Nadáciou Stock, zahŕňal stavbu dreveného mostíka, výsadbu stredomorskej zelene a farebné dokončovacie práce.",
        "Iniciatíva spojila rodičov, personál a odborníkov — spolu 159 hodín práce: 40 hodín príprav, 64 hodín stavby a terénnych úprav a 76 hodín výsadby a záverečných detailov.",
        "Výsledkom je ihrisko, ktoré slúži zároveň ako vzdelávací priestor — rozvíja kreativitu, tímovú prácu a environmentálne povedomie."
      ],
      "de": [
        "Im kroatischen Šišan wurde der örtliche Kindergarten „Bubamara“ durch ein Gemeinschaftsprojekt, an dem sich 24 Freiwillige, Erzieherinnen und Erzieher sowie Anwohner beteiligten, in einen lebendigen Ort des Lernens und Spielens verwandelt. Das teilweise von der Stiftung Stock finanzierte Projekt umfasste den Bau einer Holzbrücke, die Pflanzung mediterranen Grüns und farbenfrohe letzte Handgriffe.",
        "Die Initiative brachte Eltern, Mitarbeitende und Fachleute zusammen — insgesamt 159 Arbeitsstunden: 40 Stunden Vorbereitung, 64 Stunden Bau- und Gartenarbeiten sowie 76 Stunden für Bepflanzung und letzte Details.",
        "Das Ergebnis ist ein Spielplatz, der zugleich als Lernraum dient — er fördert Kreativität, Teamarbeit und Umweltbewusstsein."
      ],
      "fr": [
        "À Šišan, en Croatie, l’école maternelle locale « Bubamara » a été transformée en un espace vivant d’éducation et de jeu grâce à un projet communautaire qui a mobilisé 24 bénévoles, éducateurs et habitants. Financé en partie par la Fondation Stock, le projet comprenait la construction d’un pont en bois, la plantation de verdure méditerranéenne et des finitions colorées.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Kunstbegegnungen — zwischen Louvre und Versailles",
    ...
    "lead": {
      ...
      "de": "Kuratorin Magdalena Norkowska nahm die Seniorinnen und Senioren in einem der Repräsentationssäle des Rathauses mit auf eine Reise zur Residenz des Sonnenkönigs.",
    ...
    "body": {
      ...
      "sk": [
        "Projekt Stretnutí s umením, realizovaný spoločne s radnicou a Národným múzeom v Lubline pre seniorov, sa dynamicky rozvíja. Ďakujeme pani Anne Augustyniak, zástupkyni primátora Lublinu pre sociálne veci, a pánovi Sławomirovi Skowronkovi z odboru sociálnych iniciatív a programov za otvorenie stretnutia. Projekt prilákal ďalšiu vynikajúcu kurátorku — pani Magdalenu Norkowskú, ktorá v jednej z reprezentačných sál radnice predniesla prednášku „Medzi Louvrom a Versailles“.",
        "Účastníci spoznali históriu Versailles — jeho počiatky a úlohu sídla panovníka, spolu s historickým pozadím štátu za vlády Ľudovíta XIV. Videli pamiatky, ktoré možno v rezidencii obdivovať dodnes; oficiálnym sídlom kráľa sa stala v druhej polovici 17. storočia po veľkej prestavbe paláca. Ľudovít XIV. sa do Versailles presťahoval v roku 1682 a postupne tam preniesol kráľovský dvor; palác sa stal najväčším v Európe a ako jedno z najskvelejších diel klasicistického baroka prevzal od Paríža úlohu hlavného mesta Francúzska.",
        "História paláca vzbudila u účastníkov obrovský záujem a po prednáške bol čas na otázky a malé občerstvenie."
      ],
      "de": [
        "Das Projekt Kunstbegegnungen, das gemeinsam mit dem Rathaus und dem Nationalmuseum in Lublin für Seniorinnen und Senioren durchgeführt wird, entwickelt sich dynamisch. Wir danken Frau Anna Augustyniak, stellvertretender Stadtpräsidentin von Lublin für soziale Angelegenheiten, und Herrn Sławomir Skowronek von der Abteilung für soziale Initiativen und Programme für die Eröffnung des Treffens. Das Projekt gewann eine weitere herausragende Kuratorin — Frau Magdalena Norkowska, die in einem der Repräsentationssäle des Rathauses den Vortrag „Zwischen Louvre und Versailles“ hielt.",
        "Die Teilnehmerinnen und Teilnehmer lernten die Geschichte von Versailles kennen — seine Anfänge und seine Rolle als Sitz des Monarchen, zusammen mit dem historischen Hintergrund des Staates unter Ludwig XIV. Sie sahen die Denkmäler, die man in der Residenz bis heute bewundern kann; zum offiziellen Sitz des Königs wurde sie in der zweiten Hälfte des 17. Jahrhunderts nach einem großen Umbau des Schlosses. Ludwig XIV. zog 1682 nach Versailles und verlegte nach und nach den königlichen Hof dorthin; das Schloss wurde zum größten Europas und übernahm als eines der glanzvollsten Werke des klassizistischen Barocks von Paris die Rolle der Hauptstadt Frankreichs.",
        "Die Geschichte des Schlosses stieß bei den Teilnehmenden auf großes Interesse, und nach dem Vortrag blieb Zeit für Fragen und eine kleine Erfrischung."
      ],
      "fr": [
        "Le projet Rencontres avec l’art, mené conjointement avec l’hôtel de ville et le Musée national de Lublin à l’intention des seniors, se développe de manière dynamique. Nous remercions Mme Anna Augustyniak, adjointe au maire de Lublin chargée des affaires sociales, et M. Sławomir Skowronek du Département des initiatives et programmes sociaux d’avoir ouvert la rencontre. Le projet a attiré une autre remarquable conservatrice — Mme Magdalena Norkowska, qui a donné, dans l’une des salles d’apparat de l’hôtel de ville, la conférence « Entre le Louvre et Versailles ».",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Schulungen für Sozialarbeiter — eine neue Initiative der Stiftung",
    ...
    "lead": {
      ...
      "de": "Fünfundzwanzig Sozialarbeiter nahmen an den ersten Schulungen zur Unterstützung suchtgefährdeter Menschen teil, geleitet von den Psychologen Anna Kalbus und Jerzy Brożyna.",
    ...
    "body": {
      ...
      "sk": [
        "Školenia pre sociálnych pracovníkov o práci s osobami ohrozenými závislosťou sú novou iniciatívou Nadácie Stock, ktorú realizujeme v spolupráci so Združením centier podpory. Tamojší sociálni pracovníci pomáhajú denne desiatkam ľudí a stretávajú sa s prípadmi, ktoré si vyžadujú dobrý úsudok, empatiu a profesionálnu prípravu. Počas školení účastníci spoznávajú mechanizmy vzniku závislosti a dostupné formy pomoci.",
        "Prvých školení sa zúčastnilo dvadsaťpäť osôb a viedli ich naši skúsení psychológovia — pani Anna Kalbus a pán Jerzy Brożyna. Stretnutia pozostávali z miniprednášok, psychoedukácie a workshopovej časti — práce v skupinách a rôznych cvičení. Účastníci sa učili, ako pracovať s ľuďmi so závislosťou, ako funguje rodinný systém, v ktorom sa objaví závislosť, a spoznávali stratégie a techniky pomoci takýmto rodinám.",
        "Školenie im umožnilo získať kompetencie na lepšie zvládanie náročných situácií a spoznať vlastné zdroje aj obmedzenia. Workshopový charakter podnecoval k aktívnej účasti na diskusiách a cvičeniach — účastníci teraz lepšie rozumejú problému závislostí a dokážu odlíšiť škodlivé správanie od účinnej pomoci."
      ],
      "de": [
        "Schulungen für Sozialarbeiterinnen und Sozialarbeiter zur Arbeit mit suchtgefährdeten Menschen sind eine neue Initiative der Stiftung Stock, die in Zusammenarbeit mit dem Verbund der Unterstützungszentren durchgeführt wird. Die dortigen Sozialarbeitenden helfen täglich Dutzenden von Menschen und begegnen Fällen, die ein gutes Gespür, Empathie und professionelle Vorbereitung erfordern. In den Schulungen lernen die Teilnehmenden die Mechanismen der Suchtentstehung und die verfügbaren Hilfsangebote kennen.",
        "An den ersten Schulungen nahmen fünfundzwanzig Personen teil; geleitet wurden sie von unseren erfahrenen Psychologen — Frau Anna Kalbus und Herrn Jerzy Brożyna. Die Sitzungen bestanden aus Kurzvorträgen, Psychoedukation und einem Workshop-Teil — Gruppenarbeit und verschiedenen Übungen. Die Teilnehmenden lernten, wie man mit suchtkranken Menschen arbeitet, wie ein Familiensystem funktioniert, in dem eine Sucht auftritt, und sie lernten Strategien und Techniken kennen, um solchen Familien zu helfen.",
        "Die Schulung ermöglichte es ihnen, Kompetenzen für den besseren Umgang mit schwierigen Situationen zu erwerben und die eigenen Ressourcen und Grenzen kennenzulernen. Der Workshop-Charakter lud zur aktiven Beteiligung an Diskussionen und Übungen ein — die Teilnehmenden verstehen die Suchtproblematik nun besser und können schädliche Verhaltensweisen von wirksamer Hilfe unterscheiden."
      ],
      "fr": [
        "Les formations destinées aux travailleurs sociaux sur l’accompagnement des personnes exposées au risque d’addiction constituent une nouvelle initiative de la Fondation Stock, menée en coopération avec l’Ensemble des centres de soutien. Les travailleurs sociaux y aident chaque jour des dizaines de personnes et rencontrent des situations qui exigent un bon discernement, de l’empathie et une préparation professionnelle. Au cours des formations, les participants découvrent les mécanismes de développement de l’addiction et les formes d’aide disponibles.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Musikstipendien — eine außergewöhnliche Gitarre für unsere Schützlinge",
    ...
    "lead": {
      ...
      "de": "Ein anonymer Freiwilliger schenkte den Jugendlichen aus unserem Stipendienprogramm eine außergewöhnliche E-Gitarre, die 1993 vom herausragenden Gitarrenbauer Maciej Mensfeld gefertigt wurde.",
    ...
    "body": {
      ...
      "sk": [
        "Štipendijný program Nadácie Stock, ktorý v Lubline realizujeme spoločne s Homo Faber, podporuje talentovanú mládež z Ukrajiny. Nedávno jeden z dobrovoľníkov našej nadácie, ktorý si želá zostať v anonymite, venoval mladým ľuďom z programu výnimočnú elektrickú gitaru.",
        "Je to znamenitý nástroj, ktorý sa vyznačuje vynikajúcou kvalitou spracovania i použitých komponentov. Vyrobil ho v roku 1993 vynikajúci majster nástrojár Maciej Mensfeld vo svojej dielni v Nowom Targu. Danilo, ktorý gitaru používa najčastejšie, hovorí, že už dlho sa mu nehralo tak ľahko.",
        "Hodiny gitarového súboru vedie vynikajúci pedagóg Mirek Sokołowski."
      ],
      "de": [
        "Das Stipendienprogramm der Stiftung Stock, das in Lublin gemeinsam mit Homo Faber durchgeführt wird, unterstützt talentierte Jugendliche aus der Ukraine. Vor Kurzem schenkte einer der Freiwilligen unserer Stiftung, der anonym bleiben möchte, den jungen Menschen aus dem Programm eine außergewöhnliche E-Gitarre.",
        "Es ist ein hervorragendes Instrument, das sich durch die ausgezeichnete Qualität der Verarbeitung und der verwendeten Komponenten auszeichnet. Gebaut wurde es 1993 vom herausragenden Gitarrenbauer Maciej Mensfeld in seiner Werkstatt in Nowy Targ. Danilo, der diese Gitarre am häufigsten spielt, sagt, dass ihm das Spielen schon lange nicht mehr so leicht gefallen ist.",
        "Den Unterricht des Gitarrenensembles leitet der hervorragende Pädagoge Mirek Sokołowski."
      ],
      "fr": [
        "Le programme de bourses d’études de la Fondation Stock, mené à Lublin en partenariat avec Homo Faber, soutient de jeunes talents ukrainiens. Récemment, l’un des bénévoles de notre fondation, qui souhaite rester anonyme, a offert aux jeunes du programme une guitare électrique exceptionnelle.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Kunstbegegnungen — Emotionen in der Kunst",
    ...
    "lead": {
      ...
      "de": "Danuta Szewczyk-Prokurat führte die Seniorinnen und Senioren durch einen der wichtigsten Begriffe der Kunst — und zum ersten Mal beteiligten sich alle Teilnehmenden am Gespräch.",
    ...
    "body": {
      ...
      "sk": [
        "Uskutočnilo sa ďalšie Stretnutie s umením — tentoraz pre starších ľudí v starostlivosti odboru sociálnych iniciatív a programov lublinskej radnice. Témou prednášky, ktorú viedla pani Danuta Szewczyk-Prokurat, bol jeden z najdôležitejších pojmov spojených s umením — emócie.",
        "Umelci po stáročia vyjadrovali svoje emócie prostredníctvom diel a zároveň do nich vkladali prvky, ktoré mali u divákov vyvolať konkrétne asociácie a pocity. V architektúre záležalo na každom prvku stavby — na jej mierke, svetle, vitrážach. V sakrálnej architektúre mali starostlivo navrhnuté prvky prebúdzať pocit posvätna; tmavšie, slabšie osvetlené priestory vytvárali atmosféru tajomstva a duchovného sústredenia.",
        "V dielenskej časti dostali účastníci reprodukcie umeleckých diel a vyberali tie, ktoré v nich vzbudzovali emócie. Pri rozbore rôznych umeleckých prostriedkov a účinkov ich použitia skúmali pocity, ktoré konkrétne diela vyvolávajú. Do rozhovoru o svojich dojmoch sa prvýkrát aktívne zapojil doslova každý účastník stretnutia.",
        "Projekt Stretnutia s umením realizujeme spoločne s Národným múzeom v Lubline. Jeho cieľom je uľahčovať kontakt s umením ľuďom, ktorí k nemu majú sťažený prístup, vzdelávať a inšpirovať."
      ],
      "de": [
        "Es fand eine weitere Kunstbegegnung statt — diesmal für ältere Menschen, die vom Abteilung für soziale Initiativen und Programme des Lubliner Rathauses betreut werden. Thema des Vortrags von Frau Danuta Szewczyk-Prokurat war einer der wichtigsten Begriffe der Kunst — die Emotionen.",
        "Über die Jahrhunderte hinweg drückten Künstlerinnen und Künstler ihre Gefühle in ihren Werken aus und banden zugleich Elemente ein, die beim Publikum bestimmte Assoziationen und Empfindungen hervorrufen sollten. In der Architektur zählte jedes Element eines Bauwerks — sein Maßstab, das Licht, die Glasfenster. In der Sakralarchitektur sollten sorgfältig gestaltete Elemente ein Gefühl des Heiligen wecken; dunklere, schwächer beleuchtete Räume schufen eine Atmosphäre des Geheimnisses und der geistlichen Sammlung.",
        "Im Werkstattteil erhielten die Teilnehmenden Reproduktionen von Kunstwerken und wählten jene aus, die sie emotional bewegten. Bei der Analyse verschiedener künstlerischer Mittel und ihrer Wirkung gingen sie den Gefühlen nach, die einzelne Werke wecken. Zum ersten Mal beteiligte sich buchstäblich jede und jeder Anwesende aktiv am Gespräch über die eigenen Eindrücke.",
        "Das Projekt Kunstbegegnungen wird gemeinsam mit dem Nationalmuseum in Lublin durchgeführt. Sein Ziel ist es, Menschen mit erschwertem Zugang den Kontakt zur Kunst zu erleichtern, zu bilden und zu inspirieren."
      ],
      "fr": [
        "Une nouvelle Rencontre avec l’art s’est tenue — cette fois pour des personnes âgées suivies par le Département des initiatives et des programmes sociaux de la mairie de Lublin. Le thème de la conférence, animée par Mme Danuta Szewczyk-Prokurat, portait sur l’une des notions les plus importantes liées à l’art : les émotions.",
        "Au fil des siècles, les artistes ont exprimé leurs émotions à travers leurs œuvres, tout en y glissant des éléments destinés à susciter chez le public des associations et des sentiments précis. En architecture, chaque élément de l’édifice comptait : son échelle, la lumière, les vitraux. Dans l’architecture sacrée, des éléments soigneusement conçus devaient éveiller le sentiment du sacré ; les espaces plus sombres, moins éclairés, créaient une atmosphère de mystère et de recueillement.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Flavours of Change — ein Zuschuss für die Feuerwehr in Czernięcin",
    ...
    "lead": {
      ...
      "de": "Der Freiwillige Sebastian Puchała hat Mittel für die Renovierung des Feuerwehrhauses eingeworben — und die Einsatzzeit der Feuerwehr auf unter vier Minuten verkürzt.",
    ...
    "body": {
      ...
      "sk": [
        "Program „Flavours of Change Grants“ Nadácie Stock podporuje miestne komunity grantmi na pomocné projekty, do ktorých sa ako dobrovoľníci zapájajú zamestnanci Stock Polska. Spustil sa začiatkom roka a medzi víťazmi boli projekty z Česka, Talianska, Poľska a Chorvátska. Tentoraz grant putoval k dobrovoľnému hasičskému zboru v Czernięcine pri Lubline.",
        "Sebastian Puchała, aktívne zapojený ako dobrovoľník, získal prostriedky na rekonštrukciu hasičskej zbrojnice. Opravený výjazd a nový odvodňovací systém urýchlia reakciu hasičov a skrátia čas od výzvy po zásah na necelé štyri minúty. Lepšie pracovné podmienky sa priamo premietajú do efektívnejších záchranných akcií.",
        "Jednotka má k dispozícii 30 hasičov a jedno vozidlo — opotrebovaný Star nahradil modernejší MAN. Zbor nedávno oslávil veľkolepé 100. výročie a hrdo hľadí do minulosti aj do budúcnosti — do jeho činnosti sa radi zapájajú mladí ľudia.",
        "Iniciatívy podporované Nadáciou Stock posilňujú miestne komunity a prispievajú k zlepšeniu ich bezpečnosti a zapojenie dobrovoľníkov skutočne mení kvalitu života v týchto obciach."
      ],
      "de": [
        "Das Programm „Flavours of Change Grants“ der Stiftung Stock unterstützt lokale Gemeinschaften mit Zuschüssen für Hilfsprojekte, in denen sich Mitarbeitende von Stock Polska als Freiwillige engagieren. Es startete Anfang des Jahres, und zu den Gewinnern zählten Projekte aus Tschechien, Italien, Polen und Kroatien. Diesmal ging ein Zuschuss an die Freiwillige Feuerwehr in Czernięcin bei Lublin.",
        "Sebastian Puchała, der sich aktiv als Freiwilliger engagiert, warb Mittel für die Renovierung des Feuerwehrhauses ein. Die sanierte Ausfahrt und ein neues Entwässerungssystem beschleunigen die Reaktion der Feuerwehr und verkürzen die Zeit vom Alarm bis zum Einsatz auf weniger als vier Minuten. Bessere Arbeitsbedingungen schlagen sich unmittelbar in effizienteren Rettungseinsätzen nieder.",
        "Die Einheit verfügt über 30 Feuerwehrleute und ein Fahrzeug — ein ausgedienter Star wurde durch einen moderneren MAN ersetzt. Die Wehr feierte kürzlich ihr großartiges 100-jähriges Jubiläum und blickt mit Stolz sowohl in die Vergangenheit als auch in die Zukunft — junge Menschen engagieren sich gern in ihren Reihen.",
        "Die von der Stiftung Stock unterstützten Initiativen stärken lokale Gemeinschaften und tragen zu ihrer Sicherheit bei, und das Engagement der Freiwilligen verändert die Lebensqualität in diesen Orten ganz konkret."
      ],
      "fr": [
        "Le programme « Flavours of Change Grants » de la Fondation Stock soutient les communautés locales par des subventions destinées à des projets d’entraide dans lesquels les salariés de Stock Polska s’engagent comme bénévoles. Lancé au début de l’année, il a récompensé des projets venus de Tchéquie, d’Italie, de Pologne et de Croatie. Cette fois, une subvention a été attribuée aux pompiers volontaires de Czernięcin, près de Lublin.",
        "Sebastian Puchała, bénévole très engagé, a obtenu des fonds pour la rénovation de la caserne. La sortie rénovée et un nouveau système de drainage accéléreront la réaction des pompiers et ramèneront le temps entre l’alerte et l’intervention à moins de quatre minutes. De meilleures conditions de travail se traduisent directement par des opérations de secours plus efficaces.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Stipendienprogramm — die Erfolge von Viktoria Pronchakova",
    ...
    "lead": {
      ...
      "de": "Viktoria, die von unserem Stipendienprogramm unterstützt wird, gewann bei den ukrainischen Kadetten-Schwimmmeisterschaften bei Kiew mehrere Medaillen.",
    ...
    "body": {
      ...
      "sk": [
        "Skvelé správy! Viktoria Pronchakovová, ktorú Nadácia Stock podporuje v plaveckých tréningoch v rámci štipendijného programu vedeného spoločne s Homo Faber v Lubline — kde popri veľkej skupine hudobníkov trénuje aj niekoľko mladých športovcov — získala ocenenia na majstrovstvách Ukrajiny kadetov v plávaní. Konali sa 27.–29. júna v Brovaroch pri Kyjeve a zúčastnilo sa ich približne 300 pretekárov z 19 regiónov Ukrajiny. Tím Doneckej oblasti, za ktorý Viktoria pláva, obsadil na majstrovstvách 2. miesto.",
        "Samotná Viktoria získala striebornú medailu v štafete 4×50 m a bronzovú v kraulovej štafete. Svojimi výsledkami sa dostala do TOP 8 plavkýň majstrovstiev: 4. miesto na 100 m voľným spôsobom, 6. na 200 m znak a 8. na 800 m a 400 m voľným spôsobom.",
        "Viktorii gratulujeme — nesmierne nás teší, že môžeme podporovať takú talentovanú športovkyňu!"
      ],
      "de": [
        "Großartige Neuigkeiten! Viktoria Pronchakova, die die Stiftung Stock im Schwimmtraining im Rahmen des gemeinsam mit Homo Faber in Lublin geführten Stipendienprogramms unterstützt — wo neben einer großen Gruppe von Musikerinnen und Musikern auch mehrere junge Sporttalente trainieren —, hat bei den ukrainischen Kadetten-Schwimmmeisterschaften Preise gewonnen. Sie fanden vom 27. bis 29. Juni in Browary bei Kiew statt und versammelten rund 300 Teilnehmende aus 19 Regionen der Ukraine. Das Team der Oblast Donezk, für das Viktoria startet, belegte bei den Meisterschaften den 2. Platz.",
        "Viktoria selbst gewann Silber in der 4×50-m-Staffel und Bronze in der Freistilstaffel. Mit ihren Ergebnissen zählte sie zu den TOP 8 Schwimmerinnen der Meisterschaften: 4. Platz über 100 m Freistil, 6. Platz über 200 m Rücken sowie 8. Platz über 800 m und 400 m Freistil.",
        "Wir gratulieren Viktoria — wir freuen uns außerordentlich, eine so talentierte Sportlerin unterstützen zu können!"
      ],
      "fr": [
        "Excellente nouvelle ! Viktoria Pronchakova, que la Fondation Stock soutient dans ses cours de natation dans le cadre du programme de bourses d’études mené avec Homo Faber à Lublin — où, aux côtés d’un large groupe de musiciens, s’entraînent aussi plusieurs jeunes sportifs —, a remporté des prix aux championnats d’Ukraine de natation cadets. Ils se sont déroulés du 27 au 29 juin à Brovary, près de Kiev, et ont réuni environ 300 participants venus de 19 régions d’Ukraine. L’équipe de la région de Donetsk, dont Viktoria fait partie, a pris la 2e place du championnat.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Lernen Sie den Leiter unseres Gitarrenensembles kennen — Mirek Sokołowski",
    ...
    "lead": {
      ...
      "de": "Das im Mai 2022 gegründete Gitarrenensemble blüht unter der Leitung eines Lehrers mit 25 Jahren Bühnenerfahrung in Polen und Frankreich auf.",
    ...
    "body": {
      ...
      "sk": [
        "Nadácia Stock pokračuje v programe podpory talentovanej mládeže z Ukrajiny. Jednou z najaktívnejších skupín je gitarový súbor založený v máji 2022. Odvtedy sa na hodinách zúčastnili desiatky ľudí s rôznou úrovňou hudobného vzdelania — niektorí študovali na hudobných školách, iní hrali ako hobby. Zostava je už pomerne stabilná: približne 10 mladých ľudí od základnej školy po nižšiu strednú, z ktorých väčšina žije v Poľsku už dlho a chodí tu do školy. Ich úroveň možno opísať ako „pokročilí debutanti“ a hodiny sa konajú dvakrát týždenne.",
        "Súbor vedie vynikajúci pedagóg Mirek Sokołowski — autor textov a hudobný animátor. Mirek už takmer 25 rokov učí hru na gitare v Poľsku a vo Francúzsku a má za sebou niekoľko stoviek koncertov vo Francúzsku, Švajčiarsku a Poľsku. S lyonskou kapelou Malossol vyhral 14. ročník festivalu Musicales de Bastia na Korzike a v roku 2010 s lublinskou skupinou Couleur Café získal cenu W. Bellona na Študentskom festivale piesne v Krakove.",
        "V súčasnosti vedie gitarové dielne pod záštitou Homo Faber a Nadácie Stock, pracuje ako hudobný inštruktor v kultúrnych domoch a svojou vášňou pre hudbu nadchýna mladých adeptov umenia. Súbor pod jeho vedením vystupuje na koncertoch našich štipendistov — napríklad v Baobabe či na nedávnom koncerte na záver školského roka v Dielňach kultúry."
      ],
      "de": [
        "Die Stiftung Stock setzt ihr Programm zur Unterstützung talentierter Jugendlicher aus der Ukraine fort. Eine der aktivsten Gruppen ist das im Mai 2022 gegründete Gitarrenensemble. Seitdem haben Dutzende von Personen mit unterschiedlichem musikalischem Ausbildungsstand am Unterricht teilgenommen — manche lernten an Musikschulen, andere spielten als Hobby. Die Besetzung ist inzwischen recht stabil: etwa 10 junge Leute von der Grundschule bis zur Mittelstufe, von denen die meisten schon lange in Polen leben und hier zur Schule gehen. Ihr Niveau lässt sich als „fortgeschrittene Debütanten“ beschreiben, und der Unterricht findet zweimal pro Woche statt.",
        "Das Ensemble leitet ein herausragender Pädagoge, Mirek Sokołowski — Textautor und Musikanimateur. Mirek unterrichtet seit fast 25 Jahren Gitarre in Polen und Frankreich und hat mehrere Hundert Konzerte in Frankreich, der Schweiz und Polen gegeben. Mit der Lyoner Band Malossol gewann er die 14. Ausgabe des Festivals Musicales de Bastia auf Korsika, und 2010 erhielt er mit der Lubliner Gruppe Couleur Café den W.-Bellon-Preis beim Studentenliedfestival in Krakau.",
        "Derzeit leitet er Gitarrenworkshops unter der Schirmherrschaft von Homo Faber und der Stiftung Stock, arbeitet als Musiklehrer in Kulturhäusern und steckt junge Kunstschaffende mit seiner Leidenschaft für die Musik an. Das Ensemble unter seiner Obhut tritt bei Konzerten unserer Stipendiatinnen und Stipendiaten auf — zum Beispiel im Baobab oder beim jüngsten Konzert zum Abschluss des Schuljahres in den Kulturwerkstätten."
      ],
      "fr": [
        "La Fondation Stock poursuit son programme de soutien aux jeunes talents d’Ukraine. L’un des groupes les plus actifs est l’ensemble de guitares fondé en mai 2022. Depuis, des dizaines de personnes aux niveaux d’éducation musicale variés ont participé aux cours — certains ont étudié dans des écoles de musique, d’autres jouaient en amateurs. La formation est désormais assez stable : une dizaine de jeunes, de la quatrième année du primaire au collège, dont la plupart vivent en Pologne depuis longtemps et y sont scolarisés. Leur niveau peut être qualifié de « débutants avancés », et les cours ont lieu deux fois par semaine.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Konzert der Stipendiatinnen und Stipendiaten — ein Jahr Arbeit und Talent",
    ...
    "lead": {
      ...
      "de": "In den Kulturwerkstätten in Lublin ließen unsere Stipendiatinnen und Stipendiaten ein Jahr des Talentschliffs Revue passieren — vor einem bis auf den letzten Platz gefüllten Saal.",
    ...
    "body": {
      ...
      "sk": [
        "V Dielňach kultúry v Lubline sa konal krásny koncert štipendistov, ktorý zhrnul rok práce a brúsenia talentov. Nadácia Stock pokračuje v programe podpory talentovanej mládeže z Ukrajiny a umožňuje jej pokračovať v hudobnom vzdelávaní prerušenom vojnou.",
        "Na koncerte sme si s potešením vypočuli zbor „Veselyki“ pod vedením Halyny a Aleksandra Navrockých, ako aj autorské texty Mirka Sokołowského so sprievodom gitarového súboru, ktorý vedie. Kapela zahrala impresie v rokenrolovej atmosfére a zhrnula témy, na ktorých pracovala počas uplynulého roka.",
        "Prevedenie piesne s bandurou — pod vedením Oly Maciupy — vyvolalo veľké nadšenie. Publikum bolo skvelé a sála bola zaplnená do posledného miesta."
      ],
      "de": [
        "In den Kulturwerkstätten in Lublin fand ein wunderschönes Konzert der Stipendiatinnen und Stipendiaten statt, das ein Jahr der Arbeit und des Talentschliffs zusammenfasste. Die Stiftung Stock setzt ihr Programm zur Förderung talentierter Jugendlicher aus der Ukraine fort und ermöglicht ihnen, ihre durch den Krieg unterbrochene musikalische Ausbildung fortzusetzen.",
        "Beim Konzert hatten wir das Vergnügen, den Chor „Veselyki“ unter der Leitung von Halyna und Aleksandr Navrocki zu hören, ebenso wie eigene Texte von Mirek Sokołowski, begleitet von dem von ihm geleiteten Gitarrenensemble. Das Ensemble spielte Impressionen in Rock’n’Roll-Atmosphäre und fasste die Themen zusammen, an denen sie im vergangenen Jahr gearbeitet hatte.",
        "Die Darbietung eines Liedes mit Bandura — unter der Betreuung von Ola Maciupa — löste große Begeisterung aus. Das Publikum war wunderbar, und der Saal war bis auf den letzten Platz gefüllt."
      ],
      "fr": [
        "Aux Ateliers de la Culture de Lublin s’est tenu un magnifique concert des boursiers, bilan d’une année de travail et de perfectionnement des talents. La Fondation Stock poursuit son programme de soutien aux jeunes talents d’Ukraine, leur permettant de continuer une éducation musicale interrompue par la guerre.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Flavours of Change — ein Zuschuss für die Freiwillige Feuerwehr in Markuszów",
    ...
    "lead": {
      ...
      "de": "Die Freiwillige Kasia Brillowska hat einen Zuschuss für die Ausstattung der Jugendfeuerwehr gewonnen — von Geräten für Einsatzübungen bis hin zur Trainingskleidung.",
    ...
    "body": {
      ...
      "sk": [
        "Nový projekt v rámci programu Flavours of Change Grants Nadácie Stock podporuje dobrovoľných hasičov v Markuszówe. Kasia Brillowska, dobrovoľníčka Nadácie Stock, ktorá zboru pomáha, získala grant na financovanie výbavy mládežníckeho hasičského družstva: prvkov výcvikového vybavenia — lávky, nalievacieho terča, stanovišťa na viazanie uzlov — ako aj tréningového oblečenia vrátane sady dresov a flísových mikín pre mládež.",
        "Mládežnícke hasičské družstvo pôsobí pri dobrovoľných hasičoch v Markuszówe len krátko a v súčasnosti sa pripravuje na účasť v hasičských súťažiach. Stretnutia, ktoré sa konajú každý piatok na základnej škole, zahŕňajú nácvik viazania uzlov, obsluhy hasiaceho prístroja, spájania hadíc a rozpoznávania jednotlivých častí výbavy.",
        "Lekcie popularizujú medzi mladými tému požiarnej bezpečnosti a sú zároveň dobrým spôsobom trávenia času. Cieľom iniciatívy je zabezpečiť kontinuitu činnosti zboru prostredníctvom výcviku mládeže, jej zapájania do života miestnej komunity a zlepšovania jej bezpečnosti."
      ],
      "de": [
        "Ein neues Projekt im Rahmen des Programms Flavours of Change Grants der Stiftung Stock unterstützt die Freiwillige Feuerwehr in Markuszów. Kasia Brillowska, Freiwillige der Stiftung Stock, die der Feuerwehr hilft, hat einen Zuschuss zur Finanzierung der Ausstattung der Jugendfeuerwehr gewonnen: Elemente der Übungsausrüstung — ein Laufbrett, eine Spritzwand, eine Station zum Knotenbinden — sowie Trainingskleidung, darunter ein Satz Trainingsanzüge und Fleecepullover für die Jugendlichen.",
        "Die Jugendfeuerwehr besteht bei der Freiwilligen Feuerwehr Markuszów erst seit Kurzem und bereitet sich derzeit auf die Teilnahme an Feuerwehrwettbewerben vor. Bei den Treffen, die jeden Freitag in der Grundschule stattfinden, lernen die Jugendlichen, Knoten zu binden, einen Feuerlöscher zu bedienen, Schläuche zu kuppeln und die einzelnen Ausrüstungsteile zu erkennen.",
        "Der Unterricht macht junge Menschen mit dem Thema Brandschutz vertraut und ist zugleich eine sinnvolle Freizeitbeschäftigung. Ziel der Initiative ist es, den Fortbestand der Feuerwehr zu sichern, indem Jugendliche ausgebildet und in das Leben der lokalen Gemeinschaft eingebunden werden und deren Sicherheit verbessert wird."
      ],
      "fr": [
        "Un nouveau projet mené dans le cadre du programme Flavours of Change Grants de la Fondation Stock soutient les pompiers volontaires de Markuszów. Kasia Brillowska, bénévole de la Fondation Stock qui vient en aide à la caserne, a obtenu une subvention pour financer l’équipement de la section jeunesse : des éléments de matériel d’entraînement — une passerelle, une cible d’arrosage, un poste de nouage — ainsi que des vêtements d’entraînement, dont un ensemble de tenues et des sweats polaires pour les jeunes.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Kunstbegegnungen — Kuratorin Jolanta Polańska",
    ...
    "lead": {
      ...
      "de": "Die ersten Veranstaltungen unserer neuen Initiative leitete die leitende Kuratorin des Nationalmuseums in Lublin mit über 40 Jahren Museumserfahrung.",
    ...
    "body": {
      ...
      "sk": [
        "Prvé podujatia novej iniciatívy Nadácie Stock — Stretnutí s umením — viedla pani Jolanta Polańska, staršia kurátorka Národného múzea v Lubline; múzeum poskytuje nášmu projektu odbornú podporu. Pani Jolanta má úctyhodné, viac ako 40-ročné skúsenosti z práce v múzeu a kurátorsky pripravila mnoho výstav. Vedie kurzy o múzejnej činnosti a dejinách umenia a už 10 rokov vedie múzejnú sekciu Lublinskej univerzity tretieho veku.",
        "Prednášky z cyklu Stretnutia s umením sa konali v sídle Združenia centier podpory na ulici Lwowska 28 v Lubline. Pani Jolanta pozvala hostí do fascinujúceho sveta umeleckej rodiny Kossakovcov.",
        "Stretnutia sa medzi seniormi tešili veľkej obľube a prilákali mnoho ľudí, ktorí využívajú pomoc Združenia centier podpory. Cieľom iniciatívy je uľahčiť kontakt s umením ľuďom, ktorí k nemu majú sťažený prístup alebo z rôznych osobných dôvodov potrebujú podporu."
      ],
      "de": [
        "Die ersten Veranstaltungen der neuen Initiative der Stiftung Stock — der Kunstbegegnungen — leitete Frau Jolanta Polańska, leitende Kuratorin des Nationalmuseums in Lublin; das Museum unterstützt unser Projekt fachlich. Frau Jolanta verfügt über beeindruckende, mehr als 40-jährige Erfahrung in der Museumsarbeit und hat zahlreiche Ausstellungen kuratiert. Sie gibt Kurse über Museumsarbeit und Kunstgeschichte und leitet seit 10 Jahren die Museumssektion der Lubliner Universität des Dritten Lebensalters.",
        "Die Vorträge aus der Reihe Kunstbegegnungen fanden am Sitz des Verbunds der Unterstützungszentren in der Lwowska-Straße 28 in Lublin statt. Frau Jolanta lud die Gäste in die faszinierende Welt der Künstlerfamilie Kossak ein.",
        "Die Treffen erfreuten sich bei den Seniorinnen und Senioren großer Beliebtheit und zogen viele Menschen an, die die Hilfe des Verbunds der Unterstützungszentren in Anspruch nehmen. Ziel der Initiative ist es, Menschen den Kontakt mit Kunst zu erleichtern, die nur erschwerten Zugang zu ihr haben oder aus verschiedenen persönlichen Gründen Unterstützung brauchen."
      ],
      "fr": [
        "Les premières rencontres de la nouvelle initiative de la Fondation Stock — les Rencontres avec l’art — ont été animées par Mme Jolanta Polańska, conservatrice principale du Musée national de Lublin ; le musée apporte à notre projet son soutien scientifique. Mme Jolanta possède une impressionnante expérience de plus de 40 ans de travail au musée et a assuré le commissariat de nombreuses expositions. Elle anime des cours sur l’activité muséale et l’histoire de l’art et dirige depuis 10 ans la section musée de l’Université du troisième âge de Lublin.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Flavours of Change — ein Defibrillator für die Freiwillige Feuerwehr Godów",
    ...
    "lead": {
      ...
      "de": "Eines der ersten Projekte des Mitarbeiter-Freiwilligenprogramms stattet die Feuerwehrleute mit einem AED-Defibrillator, einem Übungsgerät und einer medizinischen Übungspuppe aus.",
    ...
    "body": {
      ...
      "sk": [
        "S potešením predstavujeme jeden z prvých projektov realizovaných v rámci Programu zamestnaneckého dobrovoľníctva Nadácie Stock. Dobrovoľný hasičský zbor v Godówe bude vybavený defibrilátorom AED spolu s cvičným defibrilátorom a zdravotníckou figurínou. Cieľom projektu je jednak zvýšiť zdravotnícke zručnosti hasičov, jednak poskytovať školenia prvej pomoci pre miestnu komunitu — v prospech obyvateľov aj zranených pri dopravných nehodách.",
        "Do projektu sa zapoja hasiči, miestna komunita a zamestnanci spoločnosti Stock Polska. Skúsení hasiči sa podelia o poznatky o prvej pomoci aj o tom, ako sa správať pri dopravných nehodách a požiaroch.",
        "Takéto iniciatívy zvyšujú povedomie o význame pripravenosti na núdzové situácie a bezpečnosti v komunite a čas, ktorý venovali zamestnanci-dobrovoľníci, je príkladným prejavom angažovanosti za bezpečnosť a blaho spoločenstva — dokonale zodpovedajúcim cieľom nášho programu."
      ],
      "de": [
        "Mit Freude stellen wir eines der ersten Projekte vor, die im Rahmen des Mitarbeiter-Freiwilligenprogramms der Stiftung Stock umgesetzt werden. Die Freiwillige Feuerwehr in Godów wird mit einem AED-Defibrillator sowie einem Übungsgerät und einer medizinischen Übungspuppe ausgestattet. Ziel des Projekts ist es, sowohl die medizinischen Fähigkeiten der Feuerwehrleute zu stärken als auch Erste-Hilfe-Schulungen für die örtliche Gemeinschaft anzubieten — davon profitieren die Einwohner ebenso wie Verletzte bei Verkehrsunfällen.",
        "An dem Projekt beteiligen sich die Feuerwehrleute, die örtliche Gemeinschaft und die Mitarbeiterinnen und Mitarbeiter von Stock Polska. Erfahrene Feuerwehrleute geben ihr Wissen über Erste Hilfe weiter und zeigen, wie man sich bei Verkehrsunfällen und Bränden verhält.",
        "Solche Initiativen schärfen das Bewusstsein für die Bedeutung von Notfallvorsorge und Sicherheit in der Gemeinschaft, und die Zeit, die die freiwilligen Mitarbeiterinnen und Mitarbeiter einbringen, ist ein vorbildliches Zeichen des Engagements für die Sicherheit und das Wohl der Gemeinschaft — ganz im Sinne der Ziele unseres Programms."
      ],
      "fr": [
        "Nous avons le plaisir de présenter l’un des premiers projets réalisés dans le cadre du Programme de bénévolat des salariés de la Fondation Stock. Le corps des pompiers volontaires de Godów sera équipé d’un défibrillateur AED, accompagné d’un appareil d’entraînement et d’un mannequin médical. Le projet vise à la fois à renforcer les compétences médicales des pompiers et à proposer des formations aux premiers secours à la communauté locale — au bénéfice des habitants comme des blessés lors d’accidents de la route.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Kunstbegegnungen — die Familie Kossak",
    ...
    "lead": {
      ...
      "de": "Das allererste Pilottreffen unserer neuen Initiative führte über 55 Teilnehmerinnen und Teilnehmer in die faszinierende Welt der künstlerischsten Familie Polens ein.",
    ...
    "body": {
      ...
      "it": [
        "Siamo lieti di presentare una nuova iniziativa della Fondazione Stock — Incontri con l’Arte. Il progetto mira a facilitare il contatto con l’arte alle persone che hanno bisogno di sostegno e che, per varie ragioni personali, cercano equilibrio nella propria vita. In partenariato con il Complesso dei Centri di Sostegno abbiamo organizzato a Lublino il primo incontro pilota con l’arte, guidato dalla signora Jolanta Polańska, curatrice senior del Museo Nazionale di Lublino.",
      ...
      "sk": [
        "S potešením predstavujeme novú iniciatívu Nadácie Stock — Stretnutia s umením. Projekt má uľahčovať kontakt s umením ľuďom, ktorí potrebujú podporu a z rôznych osobných dôvodov hľadajú v živote rovnováhu. V partnerstve so Združením centier podpory sme v Lubline zorganizovali prvé pilotné stretnutie s umením, ktoré viedla pani Jolanta Polańska, staršia kurátorka Národného múzea v Lubline.",
        "Účastníci — viac ako 55 osôb — mali príležitosť spoznať fascinujúci svet rodiny Kossakovcov: talentovaných maliarov Juliusza, jeho synov Wojciecha a Tadeusza a vnukov Jerzyho a Karola, ako aj mimoriadne ženy tejto rodiny — literárne osobnosti Magdalenu Samozwaniec, Mariu Pawlikowskú-Jasnorzewskú, Zofiu Kossak-Szczuckú a Simonu Kossakovú, profesorku lesníckych vied a známu ekologickú aktivistku.",
        "Naša iniciatíva bola prijatá veľmi vrelo a bolo vidieť, že má skutočný, pozitívny vplyv na životy starších ľudí."
      ],
      "de": [
        "Wir freuen uns, eine neue Initiative der Stiftung Stock vorzustellen — die Kunstbegegnungen. Das Projekt soll Menschen, die Unterstützung brauchen und aus verschiedenen persönlichen Gründen nach Gleichgewicht in ihrem Leben suchen, den Zugang zur Kunst erleichtern. In Partnerschaft mit dem Verbund der Unterstützungszentren haben wir in Lublin das erste Pilottreffen mit der Kunst organisiert, geleitet von Frau Jolanta Polańska, leitender Kuratorin des Nationalmuseums in Lublin.",
        "Die Teilnehmerinnen und Teilnehmer — über 55 Personen — hatten Gelegenheit, die faszinierende Welt der Familie Kossak kennenzulernen: die talentierten Maler Juliusz, seine Söhne Wojciech und Tadeusz sowie die Enkel Jerzy und Karol, aber auch die außergewöhnlichen Frauen dieser Familie — die literarischen Persönlichkeiten Magdalena Samozwaniec, Maria Pawlikowska-Jasnorzewska und Zofia Kossak-Szczucka sowie Simona Kossak, Professorin der Forstwissenschaften und bekannte Umweltaktivistin.",
        "Unsere Initiative wurde sehr herzlich aufgenommen, und es war deutlich zu sehen, dass sie einen realen, positiven Einfluss auf das Leben älterer Menschen hat."
      ],
      "fr": [
        "Nous avons le plaisir de présenter une nouvelle initiative de la Fondation Stock — les Rencontres avec l’art. Le projet vise à faciliter le contact avec l’art aux personnes ayant besoin de soutien et qui, pour diverses raisons personnelles, cherchent un équilibre dans leur vie. En partenariat avec l’Ensemble des centres de soutien, nous avons organisé à Lublin la première rencontre pilote avec l’art, animée par Mme Jolanta Polańska, conservatrice principale du Musée national de Lublin.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Programm für psychologische Unterstützung — die Geschichte von Frau Alona",
    ...
    "lead": {
      ...
      "de": "Der Mut, um Hilfe zu bitten, hat vielen Geschichten von Geflüchteten ein glückliches Ende gegeben. Heute teilen wir die erste davon.",
    ...
    "body": {
      ...
      "sk": [
        "Úspechom programu psychologickej podpory pre utečencov a ich deti, ktorý vedie Nadácia Stock, je to, že toľko ľudí našlo odvahu požiadať o pomoc. Vďaka tomu má mnoho príbehov o ťažkých začiatkoch utečencov šťastný koniec. Dnes sa chceme podeliť o prvý z nich.",
        "Pani Alona prišla do Poľska s osemročnou dcérou a ubytovala sa v utečeneckom centre. Po čase, zdrvená situáciou, v ktorej sa ocitla, a tým, že si so všetkým musela poradiť sama, začala nadmerne piť alkohol. Pomocnú ruku jej podala vedúca centra, ktorá privolala psychologičku spolupracujúcu s nadáciou.",
        "Pani Alona 8 mesiacov pravidelne navštevovala terapiu a dnes zostáva v kontakte s psychológom a chodí na stretnutia AA. Podpora jej umožnila stabilizovať situáciu: už poldruha roka je triezva, má stálu prácu a poľského partnera — spoznali sa na stretnutí skupiny AA, spoločne si prenajímajú byt a kúpili si auto. Plánuje dokončiť pomaturitné štúdium, aby sa mohla profesijne rozvíjať. Stabilná rodinná situácia mala pozitívny vplyv aj na jej dcéru, ktorá sa v novom prostredí cíti dobre. Veľmi nás teší, že podpora nadácie umožnila pani Alone radikálne zmeniť život."
      ],
      "de": [
        "Der Erfolg des von der Stiftung Stock durchgeführten Programms für psychologische Unterstützung für Geflüchtete und ihre Kinder liegt darin, dass so viele Menschen den Mut hatten, um Hilfe zu bitten. Dadurch haben viele Geschichten über die schwierigen Anfänge von Geflüchteten ein glückliches Ende. Heute möchten wir die erste davon teilen.",
        "Frau Alona kam mit ihrer achtjährigen Tochter nach Polen und fand Unterkunft in einem Flüchtlingszentrum. Nach einiger Zeit, überwältigt von der Situation, in der sie sich befand, und davon, dass sie allein zurechtkommen musste, begann sie, Alkohol zu missbrauchen. Die Leiterin des Zentrums reichte ihr die helfende Hand und rief eine mit der Stiftung zusammenarbeitende Psychologin hinzu.",
        "Frau Alona besuchte 8 Monate lang regelmäßig eine Therapie; heute bleibt sie in Kontakt mit einem Psychologen und geht zu AA-Treffen. Die Unterstützung hat es ihr ermöglicht, ihre Situation zu stabilisieren: Seit anderthalb Jahren ist sie nüchtern, hat eine feste Arbeit und einen polnischen Partner — sie lernten sich bei einem Treffen der AA-Gruppe kennen, mieten gemeinsam eine Wohnung und haben ein Auto gekauft. Sie plant, eine Berufsfachschule abzuschließen, um sich beruflich weiterzuentwickeln. Die stabile Familiensituation hat sich auch positiv auf ihre Tochter ausgewirkt, die sich in der neuen Umgebung gut zurechtfindet. Wir freuen uns sehr, dass die Unterstützung der Stiftung Frau Alona ermöglicht hat, ihr Leben radikal zu verändern."
      ],
      "fr": [
        "Le succès du programme de soutien psychologique pour les réfugiés et leurs enfants mené par la Fondation Stock tient au fait que tant de personnes ont eu le courage de demander de l’aide. Grâce à cela, de nombreuses histoires sur les débuts difficiles des réfugiés connaissent une fin heureuse. Aujourd’hui, nous voulons partager la première d’entre elles.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Unterstützung der Lubliner Schulen — Bilanz des Jahres 2023",
    ...
    "lead": {
      ...
      "de": "Neun Schulen, 3.800 Schülerinnen und Schüler — darunter 800 Kinder aus der Ukraine — und eine Ausstattung, die allen dient und Geflüchteten bei der Integration hilft.",
    ...
    "body": {
      ...
      "sk": [
        "Program Nadácie Stock na podporu lublinských škôl prostredníctvom priamych darov je iniciatívou s veľkým spoločenským dosahom. Zakúpené vybavenie je k dispozícii všetkým žiakom, pomáha pri integrácii utečencov a v dlhodobom horizonte poslúži aj ďalším školským účelom.",
        "V roku 2023 program zahŕňal 9 lublinských škôl a 3 800 žiakov — prijímateľov školskej pomoci, vrátane 800 detí z Ukrajiny. Financovali sme 600 školských výbav, vybavili triedy potrebným zariadením a školské kluby novým nábytkom, nakúpili materiály a papiernické potreby a podporili organizáciu integračných podujatí.",
        "Kľúčovou zásadou programu je rovnosť — zakúpené vybavenie slúži všetkým žiakom — a samotný program zohráva dôležitú úlohu pri začleňovaní utečeneckých detí do školskej komunity."
      ],
      "de": [
        "Das Programm der Stiftung Stock zur Unterstützung der Lubliner Schulen durch direkte Spenden ist eine Initiative mit großer gesellschaftlicher Wirkung. Die angeschaffte Ausstattung steht allen Schülerinnen und Schülern zur Verfügung, hilft bei der Integration von Geflüchteten und wird langfristig auch anderen schulischen Zwecken dienen.",
        "Im Jahr 2023 umfasste das Programm 9 Lubliner Schulen und 3.800 Schülerinnen und Schüler — Empfänger der Schulhilfe, darunter 800 Kinder aus der Ukraine. Wir finanzierten 600 Schulstartpakete, statteten Klassenzimmer mit der notwendigen Ausrüstung und Aufenthaltsräume mit neuen Möbeln aus, kauften Materialien und Schreibwaren und unterstützten die Organisation von Integrationsveranstaltungen.",
        "Ein zentraler Grundsatz des Programms ist die Gleichheit — die angeschaffte Ausstattung dient allen Schülerinnen und Schülern — und das Programm selbst spielt eine wichtige Rolle bei der Integration geflüchteter Kinder in die Schulgemeinschaft."
      ],
      "fr": [
        "Le programme de la Fondation Stock de soutien aux écoles de Lublin par des dons directs est une initiative à fort impact social. Les équipements achetés sont à la disposition de tous les élèves, aident les réfugiés à s’intégrer et, à long terme, serviront aussi à d’autres besoins scolaires.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Musikstipendien — Bilanz des Jahres 2023",
    ...
    "lead": {
      ...
      "de": "Neunzig Geförderte, 1.620 Stunden Musikunterricht und fünf ukrainische Lehrkräfte — ein Jahr der Musik als Therapie.",
    ...
    "body": {
      ...
      "sk": [
        "Štipendijný program realizovaný v spolupráci so združením Homo Faber je ďalším dôležitým projektom Nadácie Stock. Iniciatíva poskytuje talentovanej mládeži z Ukrajiny hudobné vzdelávanie prerušené vojnou a pomáha jej vyrovnávať sa s ťažkými zážitkami prostredníctvom zapojenia do hudby.",
        "V roku 2023 program podporil 90 prijímateľov a 1 620 hodín hudobných lekcií v spolupráci s piatimi vysokokvalifikovanými ukrajinskými učiteľmi. Dáva mladým ľuďom šancu pokračovať v hudobnom vzdelávaní prerušenom vypuknutím vojny a zapojenie do hudby a umeleckého prejavu chápe ako terapeutický nástroj na zvládanie traumy.",
        "Program podporuje mladých ľudí v znovunachádzaní životnej rovnováhy — a zároveň vytvára príležitosť zamestnať a podporiť ukrajinských učiteľov."
      ],
      "de": [
        "Das in Zusammenarbeit mit dem Verein Homo Faber durchgeführte Stipendienprogramm ist ein weiteres wichtiges Projekt der Stiftung Stock. Die Initiative ermöglicht talentierten Jugendlichen aus der Ukraine die durch den Krieg unterbrochene musikalische Ausbildung und hilft ihnen, schwierige Erfahrungen durch die Beschäftigung mit Musik zu bewältigen.",
        "Im Jahr 2023 unterstützte das Programm 90 Geförderte mit 1.620 Stunden Musikunterricht, in Zusammenarbeit mit fünf hochqualifizierten ukrainischen Lehrkräften. Es gibt jungen Menschen die Chance, die durch den Kriegsausbruch unterbrochene musikalische Ausbildung fortzusetzen, und versteht die Beschäftigung mit Musik und künstlerischem Ausdruck als therapeutisches Mittel zur Bewältigung von Traumata.",
        "Das Programm unterstützt junge Menschen dabei, ihr Lebensgleichgewicht wiederzufinden — und schafft zugleich die Möglichkeit, ukrainische Lehrkräfte zu beschäftigen und zu unterstützen."
      ],
      "fr": [
        "Le programme de bourses d’études mené en coopération avec l’association Homo Faber est un autre projet important de la Fondation Stock. L’initiative offre aux jeunes talents ukrainiens l’éducation musicale interrompue par la guerre et les aide à surmonter des expériences difficiles grâce à leur engagement dans la musique.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Programm für psychologische Unterstützung — Bilanz",
    ...
    "lead": {
      ...
      "de": "Hundert unterstützte Personen und 1.200 Stunden Einzelsitzungen mit erfahrenen, in der Ukraine ausgebildeten Psychologen.",
    ...
    "body": {
      ...
      "sk": [
        "Nadácia Stock od začiatku humanitárnej krízy spojenej s vojnou na Ukrajine reaguje na výzvy prílevu utečencov do Lublinu a realizuje projekty, ktoré ich podporujú v mnohých oblastiach života. Jedným z nich je program psychologickej podpory pre traumatizovaných utečencov a ich deti.",
        "Program poskytol psychologickú podporu 100 osobám v rámci 1 200 hodín individuálnych sedení, v spolupráci s tromi psychológmi vzdelanými na Ukrajine a plynulo hovoriacimi po poľsky — terapeutmi s dlhoročnými skúsenosťami a vysokou odbornou kompetenciou.",
        "Program vytvára bezpečné prostredie bez hodnotenia, v ktorom možno hovoriť o ťažkých emóciách a problémoch, učiť sa praktické nástroje na zvládanie stresu a traumy — relaxačné techniky, cvičenia všímavosti a dychové cvičenia — a účinne čeliť výzvam adaptácie na novú životnú situáciu."
      ],
      "de": [
        "Die Stiftung Stock reagiert seit Beginn der humanitären Krise im Zusammenhang mit dem Krieg in der Ukraine auf die Herausforderungen des Zustroms von Geflüchteten nach Lublin und setzt Projekte um, die sie in vielen Lebensbereichen unterstützen. Eines davon ist das Programm für psychologische Unterstützung für traumatisierte Geflüchtete und ihre Kinder.",
        "Das Programm bot 100 Personen psychologische Unterstützung im Rahmen von 1.200 Stunden Einzelsitzungen, in Zusammenarbeit mit drei in der Ukraine ausgebildeten Psychologen, die fließend Polnisch sprechen — Therapeuten mit langjähriger Erfahrung und hoher fachlicher Kompetenz.",
        "Das Programm schafft ein sicheres, wertungsfreies Umfeld, in dem man über schwierige Emotionen und Probleme sprechen, praktische Werkzeuge zur Bewältigung von Stress und Trauma erlernen kann — Entspannungstechniken, Achtsamkeits- und Atemübungen — und den Herausforderungen der Anpassung an eine neue Lebenssituation wirksam begegnen kann."
      ],
      "fr": [
        "Depuis le début de la crise humanitaire liée à la guerre en Ukraine, la Fondation Stock répond aux défis de l’afflux de réfugiés à Lublin en réalisant des projets qui les soutiennent dans de nombreux aspects de leur vie. L’un d’eux est le programme de soutien psychologique pour les réfugiés traumatisés et leurs enfants.",
  ...
  },
  {
    ...
    "lead": {
      ...
      "de": "Über 100 Teilnehmende und 632 Unterrichtsstunden — Sprachkenntnisse, die zu Arbeit, Diplomen und Neuanfängen wurden.",
    ...
    "body": {
      ...
      "sk": [
        "Začiatok nového roka je skvelý čas na zhrnutie jednej z najstarších iniciatív Nadácie Stock — programu pre utečencov Spirit of Ukraine a kurzov poľštiny. Nami financovaný program prebiehal od júla 2022 do decembra 2023 v spolupráci s IKO — Inštitútom vzdelávania cudzincov.",
        "Zúčastnilo sa ho vyše 100 osôb — 60 % na začiatočníckej úrovni a 40 % na stredne pokročilej — ktoré absolvovali 632 lekcií v 7 skupinách. Účastníci získali jazykové kompetencie umožňujúce dorozumieť sa po poľsky, čo im uľahčilo integráciu a nástup do zamestnania.",
        "Ako hovoria samotní účastníci, pomoc mala skutočný vplyv na ich životy: pani Viktoria začala pracovať v škole, pani Tetiana z Hrubieszówa zložila skúšku v lekárskej komore a pracuje ako lekárka v nemocnici, pani Anna pracuje ako zubárka, pani Maja sa presťahovala do Varšavy, pani Yulia pracuje vo firme v Lubline a pani Tetiana ako administratívna technička na obecnom úrade. Ďakujeme všetkým za nasadenie a gratulujeme k úspechom!"
      ],
      "de": [
        "Der Beginn des neuen Jahres ist ein guter Moment, um Bilanz über eine der frühesten Initiativen der Stiftung Stock zu ziehen — das Flüchtlingsprogramm Spirit of Ukraine und die Polnischkurse. Das von uns finanzierte Programm wurde von Juli 2022 bis Dezember 2023 in Zusammenarbeit mit IKO, dem Institut für die Bildung von Ausländern, durchgeführt.",
        "Mehr als 100 Personen nahmen teil — 60 % auf Anfängerniveau und 40 % auf mittlerem Niveau — und absolvierten 632 Unterrichtsstunden in 7 Gruppen. Die Teilnehmenden erwarben Sprachkompetenzen, die ihnen die Verständigung auf Polnisch ermöglichen, was ihre Integration und die Aufnahme einer Arbeit erleichterte.",
        "Wie die Teilnehmenden selbst sagen, hatte die Hilfe einen realen Einfluss auf ihr Leben: Frau Viktoria hat begonnen, an einer Schule zu arbeiten, Frau Tetiana aus Hrubieszów hat die Prüfung bei der Ärztekammer bestanden und arbeitet als Ärztin in einem Krankenhaus, Frau Anna arbeitet als Zahnärztin, Frau Maja ist nach Warschau gezogen, Frau Yulia arbeitet in einem Unternehmen in Lublin und Frau Tetiana als Bürotechnikerin in der Gemeindeverwaltung. Wir danken allen für ihr Engagement und gratulieren zu den Erfolgen!"
      ],
      "fr": [
        "Le début de la nouvelle année est un excellent moment pour dresser le bilan de l’une des toutes premières initiatives de la Fondation Stock — le programme pour réfugiés Spirit of Ukraine et les cours de langue polonaise. Financé par nos soins, le programme a été mis en œuvre de juillet 2022 à décembre 2023 en coopération avec IKO, l’Institut de formation des étrangers.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Flavours of Change Grants — verändern wir die Welt gemeinsam",
    ...
    "lead": {
      ...
      "de": "Wir haben unser internationales Mitarbeiter-Freiwilligenprogramm gestartet — Zuschüsse von bis zu 2.200 Euro für gemeinnützige Projekte, die von Stock-Mitarbeitenden eingereicht werden.",
    ...
    "body": {
      ...
      "sk": [
        "Rok sme zakončili s veľkým nadšením — oznámili sme štart medzinárodného programu zamestnaneckého dobrovoľníctva Nadácie Stock, Flavours of Change Grants!",
        "Hlavnými cieľmi programu sú povzbudzovať zamestnancov Stock Spirits Group k dobrovoľníctvu a účasti na projektoch v prospech ich komunít, podporovať projekty reagujúce na rozmanité potreby komunít a rozvíjať u zamestnancov zmysel pre spoločenskú zodpovednosť.",
        "Nadácia vyzýva všetkých zamestnancov SSG, ktorí chcú konať v prospech svojej komunity, aby prihlásili projekty potrebujúce finančnú podporu. K dispozícii sú granty do 2 200 eur v závislosti od rozsahu a dosahu navrhovaného projektu.",
        "Hľadáme projekty v súlade s našou misiou podpory, inklúzie, komunitného zapojenia, vzdelávania a udržateľného rozvoja — v oblastiach ako zdravie, umenie a kultúra, služby pre komunitu či zlepšovanie miestneho prostredia. Chceme, aby reagovali na naliehavé potreby a priniesli čo najväčšiu zmenu."
      ],
      "de": [
        "Wir haben das Jahr mit großer Begeisterung beendet und den Start des internationalen Mitarbeiter-Freiwilligenprogramms der Stiftung Stock angekündigt — Flavours of Change Grants!",
        "Die Hauptziele des Programms sind, die Beschäftigten der Stock Spirits Group zu freiwilligem Engagement und zur Teilnahme an Projekten für ihre Gemeinschaften zu ermutigen, Projekte zu fördern, die auf die vielfältigen Bedürfnisse der Gemeinschaften eingehen, und das Verantwortungsbewusstsein der Mitarbeitenden zu stärken.",
        "Die Stiftung lädt alle SSG-Mitarbeitenden, die sich für ihre Gemeinschaft einsetzen möchten, dazu ein, Projekte einzureichen, die finanzielle Unterstützung benötigen. Je nach Umfang und Wirkung des vorgeschlagenen Projekts stehen Zuschüsse von bis zu 2.200 Euro zur Verfügung.",
        "Wir suchen Projekte, die zu unserer Mission aus Unterstützung, Inklusion, gesellschaftlichem Engagement, Bildung und Nachhaltigkeit passen — in Bereichen wie Gesundheit, Kunst und Kultur, Dienste für die Gemeinschaft oder Verbesserung des lokalen Umfelds. Sie sollen auf dringende Bedürfnisse eingehen und möglichst viel bewirken."
      ],
      "fr": [
        "Nous avons terminé l’année avec beaucoup d’enthousiasme en annonçant le lancement du programme international de bénévolat des salariés de la Fondation Stock : les Flavours of Change Grants !",
        "Les principaux objectifs du programme sont d’encourager les salariés de Stock Spirits Group à faire du bénévolat et à participer à des projets au bénéfice de leurs communautés, de soutenir des projets répondant aux besoins variés de ces communautés et de développer le sens de la responsabilité sociale parmi les collaborateurs.",
  ...
  },
  {
    ...
    "title": {
      ...
      "de": "Konzert „Winter, mit Klang gemalt“",
    ...
    "lead": {
      ...
      "de": "Chor, Gitarren, Akkordeon, Klavier, Violine und Bandura erfüllten das Baobab beim Konzert unserer Stipendiatinnen und Stipendiaten mit festlicher Stimmung.",
    ...
    "body": {
      ...
      "sk": [
        "Nedávno sme mali to potešenie počúvať našich štipendistov na koncerte „Zima maľovaná zvukom“, ktorý zorganizovalo Homo Faber. Spev zboru a zvuky gitary, akordeónu, klavíra, huslí, bandury a ďalších nástrojov naplnili Baobab a vniesli medzi účastníkov sviatočnú náladu.",
        "Štipendijný program Nadácie Stock, ktorého partnerom je Homo Faber, umožňuje talentovaným ukrajinským deťom pokračovať v hudobnom vzdelávaní prerušenom vypuknutím vojny a zároveň podporuje profesijnú aktivizáciu ukrajinských učiteľov.",
        "Mladí hudobníci môžu pokračovať vo svojej vášni a rozvíjať zručnosti, čo im pomáha znovu nachádzať životnú rovnováhu. Počas tohto výnimočného koncertu nám ukázali svoje talenty — boli to naozaj čarovné chvíle."
      ],
      "de": [
        "Vor Kurzem hatten wir das Vergnügen, unseren Stipendiatinnen und Stipendiaten beim Konzert „Winter, mit Klang gemalt“ zuzuhören, das Homo Faber veranstaltete. Der Gesang des Chores sowie die Klänge von Gitarre, Akkordeon, Klavier, Violine, Bandura und weiteren Instrumenten erfüllten das Baobab und versetzten das Publikum in festliche Stimmung.",
        "Das Stipendienprogramm der Stiftung Stock, dessen Partner Homo Faber ist, ermöglicht begabten ukrainischen Kindern, ihre durch den Kriegsausbruch unterbrochene musikalische Ausbildung fortzusetzen, und unterstützt zugleich die berufliche Eingliederung ukrainischer Lehrkräfte.",
        "Die jungen Musikerinnen und Musiker können ihrer Leidenschaft weiter nachgehen und ihre Fähigkeiten entwickeln, was ihnen hilft, ihr inneres Gleichgewicht wiederzufinden. Bei diesem besonderen Konzert zeigten sie uns ihr Talent — es waren wirklich magische Momente."
      ],
      "fr": [
        "Nous avons récemment eu le plaisir d’écouter nos boursiers lors du concert « L’hiver peint par le son », organisé par Homo Faber. Le chant de la chorale et les sons de la guitare, de l’accordéon, du piano, du violon, de la bandoura et d’autres instruments ont empli le Baobab, plongeant le public dans une atmosphère de fête.",
